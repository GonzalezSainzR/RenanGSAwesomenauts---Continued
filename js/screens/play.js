game.PlayScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        game.data.minimap = me.pull("minimap", 10, 10, {});
        ...
        me.input.bindKey(me.input.KEY.L, "dance");
        ...
        me.audio.playTrack("VolatileReaction", false, null, 0.2);
    ...
    onDestroyEvent: function() {
        ...
        // stop the current audio track
            me.audio.stopTrack("");
            // me.audio.stopTrack("WhoLikestoParty");
    },
    resetPlayer: function(x, y) {
        game.data.miniplayer = me.pull("miniplayer", 10, 10, {});
