 ...
 *
 */
if (window.me = window.me || {}, "function" == typeof define && define.amd && define("me", [], function() {
    return window.me
}), function() {
    function a() {
        if (!d) {
...
if (function() {
    ...
    Object.defineProperty(Object.prototype, "extend", {value: function() {
            function c() {
...
}(), me.Error = Error.extend({init: function(a) {
    ...
    return~~(Math.pow(Math.random(), 2) * (b - a + 1)) + a
}, Number.prototype.round = function() {
    var a = arguments.length < 2 ? this : arguments[0], b = Math.pow(10, arguments[1] || arguments[0] || 0);
    ...
    return a[Number.prototype.random(0, a.length - 1)]
}, Array.prototype.weightedRandom = function(a) {
    return a[Number.prototype.weightedRandom(0, a.length - 1)]
}, "undefined" == typeof window.performance && (window.performance = {}), "undefined" == typeof Date.now && (Date.now = function() {
...
!function() {
    me.mod = "melonJS", me.version = "1.1.0", me.sys = {fps: 60, interpolation: !1, scale: null, scalingInterpolation: !1, gravity: void 0, stopOnAudioError: !0, pauseOnBlur: !0, resumeOnFocus: !0, stopOnBlur: !1, preRender: !1, checkVersion: function(a, b) {
            b = b || me.version;
    ...
    var a = !1;
    Object.defineProperty(me, "initialized", {get: function() {
            return a
        }}), me.boot = function() {
    ...
    me.game = function() {
        ...
        return a.viewport = null, a.collisionMap = null, a.currentLevel = null, a.world = null, a.mergeGroup = !0, a.sortOn = "z", a.tmxRenderer = null, a.onLevelLoaded = null, a.init = function(d, e) {
            b || (d = d || me.video.renderer.getWidth(), e = e || me.video.renderer.getHeight(), a.viewport = new me.Viewport(0, 0, d, e), a.world = new me.Container(0, 0, d, e), a.world.name = "rootContainer", me.collision.init(), f = me.video.renderer, me.event.publish(me.event.GAME_INIT), me.input._translatePointerEvents(), c = !0, a.currentLevel = {pos: {x: 0, y: 0}}, a.defaultCollisionMap = new me.CollisionTiledLayer(d, e), b = !0)
        }, a.reset = function() {
            me.collision.quadTree.clear(), a.world.destroy(), a.viewport && a.viewport.reset(), a.currentLevel = {pos: {x: 0, y: 0}}, a.collisionMap = a.defaultCollisionMap, f.resetTransform(), d = 0, e = Math.round(60 / me.sys.fps)
    ...
    me.device = function() {
        ...
        return c._check = function() {
    ...
    }(), Object.defineProperty(me.device, "isFullscreen", {get: function() {
            ...
            return!1
        }}), Object.defineProperty(me.device, "sound", {get: function() {
    ...
    me.pool = function() {
        ...
        return a.init = function() {
            ...
            return d ? void(b[a.toLowerCase()] = {"class": c, pool: []}) : void(b[a.toLowerCase()] = {"class": c, pool: void 0})
        }, a.pull = function(a) {
            var c = "string" == typeof a ? a.toLowerCase() : void 0, d = Array.prototype.slice.call(arguments);
            if (c && b[c]) {
                var e;
                if (!b[c].pool)
                    return e = b[c]["class"], d[0] = e, new (e.bind.apply(e, d));
                var f, g = b[c];
    ...
    me.Vector2d = Object.extend({init: function(a, b) {
        ...
        }}), me.Vector2d.Error = me.Error.extend({init: function(a) {
            me.Error.prototype.init.apply(this, [a]), this.name = "me.Vector2d.Error"
        }})
}(), function() {
    me.Rect = Object.extend({init: function(a, b, c, d) {
            this.pos = new me.Vector2d(a, b), this.width = c, this.height = d, this.shapeType = "Rectangle", this.hWidth = ~~(c / 2), this.hHeight = ~~(d / 2)
            ...
            return new me.PolyShape(a.x, a.y, [new me.Vector2d, new me.Vector2d(b, 0), new me.Vector2d(b, c), new me.Vector2d(0, c)], !0)
        }, draw: function(a, b) {
            a.strokeRect(this.left, this.top, this.width, this.height, b || "red", 1)
        }}), Object.defineProperty(me.Rect.prototype, "left", {get: function() {
            return this.pos.x
        }, configurable: !0}), Object.defineProperty(me.Rect.prototype, "right", {get: function() {
            return this.pos.x + this.width
        }, configurable: !0}), Object.defineProperty(me.Rect.prototype, "top", {get: function() {
            return this.pos.y
        }, configurable: !0}), Object.defineProperty(me.Rect.prototype, "bottom", {get: function() {
            return this.pos.y + this.height
        }, configurable: !0})
}(), function() {
    me.Ellipse = Object.extend({init: function(a, b, c, d) {
            this.pos = new me.Vector2d, this.bounds = void 0, this.radius = new me.Vector2d, this.shapeType = "Ellipse", this.setShape(a, b, c, d)
        }, setShape: function(a, b, c, d) {
            return this.pos.set(a, b), this.radius.set(c / 2, d / 2), this.updateBounds(), this
        }, translate: function(a, b) {
            ...
            var a = this.pos.x - this.radius.x, b = this.pos.y - this.radius.y, c = 2 * this.radius.x, d = 2 * this.radius.y;
            return this.bounds ? this.bounds.setShape(a, b, c, d) : this.bounds = new me.Rect(a, b, c, d), this.bounds
        }, clone: function() {
            return new me.Ellipse(this.pos.x, this.pos.y, 2 * this.radius.x, 2 * this.radius.y)
        }, draw: function(a, b) {
            a.strokeArc(this.pos.x, this.pos.y, this.radius.x, this.radius.y, 0, 2 * Math.PI, b || "red", !1, 1)
        }})
}(), function() {
    me.PolyShape = Object.extend({init: function(a, b, c, d) {
            this.pos = new me.Vector2d, this.bounds = void 0, this.points = null, this.closed = !1, this.shapeType = "PolyShape", this.setShape(a, b, c, d)
        }, setShape: function(a, b, c, d) {
            return this.pos.set(a, b), this.points = c, this.closed = d === !0, this.recalc(), this.updateBounds(), this
        }, recalc: function() {
            var a, b = this.edges = [], c = this.normals = [], d = this.points, e = d.length;
            for (a = 0; e > a; a++) {
                var f = d[a], g = e - 1 > a ? d[a + 1] : d[0], h = (new me.Vector2d).copy(g).sub(f), i = (new me.Vector2d).copy(h).perp().normalize();
                b.push(h), c.push(i)
            }
            return this
        }, translate: function(a, b) {
            ...
            }), new me.PolyShape(this.pos.x, this.pos.y, a, this.closed)
        }, draw: function(a, b) {
            a.save(), a.strokePolyShape(this, b, 1), a.restore()
        }})
}(), function() {
    me.Matrix2d = Object.extend({init: function(a, b, c, d, e, f) {
            this.a = a || 1, this.b = b || 0, this.c = c || 0, this.d = d || 1, this.e = e || 0, this.f = f || 0
        }, identity: function() {
            ...
            if (0 !== a) {
                var b = Math.cos(a), c = Math.sin(a), d = this.a, e = this.b, f = this.c, g = this.d, h = this.e, i = this.f;
    ...
    me.Body = me.Rect.extend({init: function(a) {
            this.entity = a, this.shapes = [], this.shapeIndex = 0, this.onCollision = void 0, this.collisionMask = me.collision.types.ALL_OBJECT, this.collisionType = me.collision.types.ENEMY_OBJECT, "undefined" == typeof this.vel && (this.vel = new me.Vector2d), this.vel.set(0, 0), "undefined" == typeof this.accel && (this.accel = new me.Vector2d), this.accel.set(0, 0), "undefined" == typeof this.friction && (this.friction = new me.Vector2d), this.friction.set(0, 0), "undefined" == typeof this.maxVel && (this.maxVel = new me.Vector2d), this.maxVel.set(1e3, 1e3), this.gravity = "undefined" != typeof me.sys.gravity ? me.sys.gravity : .98, this.falling = !1, this.jumping = !0, this.slopeY = 0, this.onslope = !1, this.onladder = !1, this.disableTopLadderCollision = !1, this.canBreakTile = !1, this.onTileBreak = null, this.collisionMap = me.game.collisionMap, this._super(me.Rect, "init", [0, 0, a.width, a.height])
        }, addShape: function(a) {
            this.shapes.push("Rectangle" === a.shapeType ? a.toPolygon() : a), 1 === this.shapes.length && this.setShape(0)
        }, getShape: function() {
            return this.shapes[this.shapeIndex]
        }, setShape: function(a) {
            if ("undefined" != typeof this.shapes[a])
                return this.shapeIndex = a, void this.updateBounds();
            throw new me.Body.Error("Shape (" + a + ") not defined")
        }, setCollisionMask: function(a) {
            this.collisionMask = a
        }, updateBounds: function(a) {
            var b = a || this.getShape().getBounds();
            this.pos.setV(b.pos), this.resize(b.width, b.height), this.entity.updateBounds()
            ...
            a !== this.lastflipX && this.shapes.length && "function" == typeof this.getShape().flipX && this.getShape().flipX(this.width)
        }, flipY: function(a) {
            a !== this.lastflipY && this.shapes.length && "function" == typeof this.getShape().flipY && this.getShape().flipY(this.height)
            ...
            if (this.collisionMask & me.collision.types.WORLD_SHAPE) {
                var b = this.entity.getBounds();
                a = this.collisionMap.checkCollision(b, this.vel), this.onslope = a.yprop.isSlope || a.xprop.isSlope, this.onladder = !1;
                var c = a.yprop, d = a.ytile;
                a.y && (this.onladder = c.isLadder || c.isTopLadder, a.y > 0 ? c.isSolid || c.isPlatform && b.bottom - 1 <= d.pos.y || c.isTopLadder && !this.disableTopLadderCollision ? (this.vel.y = this.falling ? d.pos.y - b.bottom : 0, this.falling = !1) : c.isSlope && !this.jumping ? (this.checkSlope(b, d, c.isLeftSlope), this.falling = !1) : c.isBreakable && (this.canBreakTile ? (me.game.currentLevel.clearTile(d.col, d.row), this.onTileBreak && this.onTileBreak()) : (this.vel.y = this.falling ? d.pos.y - b.bottom : 0, this.falling = !1)) : a.y < 0 && (c.isPlatform || c.isLadder || c.isTopLadder || (this.gravity && (this.falling = !0), this.vel.y = 0))), c = a.xprop, d = a.xtile, a.x && (this.onladder = c.isLadder || c.isTopLadder, c.isSlope && !this.jumping ? (this.checkSlope(b, d, c.isLeftSlope), this.falling = !1) : c.isPlatform || c.isLadder || c.isTopLadder || (c.isBreakable && this.canBreakTile ? (me.game.currentLevel.clearTile(d.col, d.row), this.onTileBreak && this.onTileBreak()) : this.vel.x = 0)), this.entity.pos.setV(b.pos).sub(this.getShape().getBounds().pos)
            }
            return this.entity.pos.add(this.vel), this.updateBounds(), a
        }, destroy: function() {
            this.entity = null, this.shapes = [], this.shapeIndex = 0
        }}), me.Body.Error = me.Error.extend({init: function(a) {
    ...
    var d = [], e = function(a, b, c, e) {
        if (d.length > 0) {
            var f = d.pop();
            return f.bounds = a, f.max_objects = b || 4, f.max_levels = c || 4, f.level = e || 0, f
        }
        return new me.QuadTree(a, b, c, e)
    }, f = function(a) {
        d.push(a)
    };
    c.prototype.split = function() {
        var a = this.level + 1, c = b.round(this.bounds.width / 2), d = b.round(this.bounds.height / 2), f = b.round(this.bounds.pos.x), g = b.round(this.bounds.pos.y);
        this.nodes[0] = e({pos: {x: f + c, y: g}, width: c, height: d}, this.max_objects, this.max_levels, a), this.nodes[1] = e({pos: {x: f, y: g}, width: c, height: d}, this.max_objects, this.max_levels, a), this.nodes[2] = e({pos: {x: f, y: g + d}, width: c, height: d}, this.max_objects, this.max_levels, a), this.nodes[3] = e({pos: {x: f + c, y: g + d}, width: c, height: d}, this.max_objects, this.max_levels, a)
    ...
    }, c.prototype.insertContainer = function(a) {
        for (var b, c = a.children.length; c--, b = a.children[c]; )
            b instanceof me.Container ? this.insertContainer(b) : "undefined" != typeof b.body && this.insert(b)
    }, c.prototype.insert = function(a) {
        var b = -1;
        if (this.nodes.length > 0 && (b = this.getIndex(a.getBounds()), -1 !== b))
        ...
        if (this.objects.push(a), this.objects.length > this.max_objects && this.level < this.max_levels) {
            ...
            for (var c = 0; c < this.objects.length; )
                b = this.getIndex(this.objects[c].getBounds()), -1 !== b ? this.nodes[b].insert(this.objects.splice(c, 1)[0]) : c += 1
        }
        ...
        if (this.nodes.length > 0) {
            ...
            if (-1 !== c)
                b = b.concat(this.nodes[c].retrieve(a));
            else
                for (var d = 0; d < this.nodes.length; d += 1)
        ...
        for (var b = 0; b < this.nodes.length; b += 1)
            this.nodes[b].clear(a), f(this.nodes[b]);
    ...
    function b(b, c, d, e, f, h) {
        ...
        if (a(d, f, j), a(e, f, k), k[0] += m, k[1] += m, j[0] > k[1] || k[0] > j[1])
    ...
    me.collision = function() {
        var a = {};
        return a.quadTree = null, a.maxDepth = 4, a.maxChildren = 8, a.bounds = null, a.SAT = !0, a.types = {NO_OBJECT: 0, PLAYER_OBJECT: 1, NPC_OBJECT: 2, ENEMY_OBJECT: 4, COLLECTABLE_OBJECT: 8, ACTION_OBJECT: 16, PROJECTILE_OBJECT: 32, WORLD_SHAPE: 64, WORLD_BOUNDARY: 128, ALL_OBJECT: 4294967295}, a.init = function() {
            ...
            this.a = null, this.b = null, this.overlapN = new me.Vector2d, this.overlapV = new me.Vector2d, this.clear()
        ...
        }, a.check = function(b, c, d, e, f) {
            for (var g, h = 0, i = e ? f || a.response.clear() : void 0, j = b.body.getShape().shapeType, k = a.quadTree.retrieve(b), l = k.length; (l--, g = k[l]) && (!g.inViewport && !g.alwaysUpdate || g === b || !a.shouldCollide(b, g) || !b.getBounds().overlaps(g.getBounds()) || a.SAT && !a["test" + j + g.body.getShape().shapeType].call(this, b, b.body.getShape(), g, g.body.getShape(), i) || (h++, a.SAT && (i && (i.x = i.overlapV.x, i.y = i.overlapV.y, i.type = i.b.body.collisionType, i.obj = i.b), "function" == typeof g.body.onCollision && g.body.onCollision.call(g.body, i, b), "function" == typeof d && d(i)), c !== !1)); )
                ;
            return h > 0
        }, a.testPolyShapePolyShape = function(a, c, d, e, f) {
            var h, i = c.points, j = i.length, k = e.points, l = k.length, m = g.pop().copy(a.pos).add(c.pos), n = g.pop().copy(d.pos).add(e.pos);
            for (h = 0; j > h; h++)
                if (b(m, n, i, k, c.normals[h], f))
                    return g.push(m), g.push(n), !1;
            for (h = 0; l > h; h++)
                if (b(m, n, i, k, e.normals[h], f))
                    return g.push(m), g.push(n), !1;
            return f && (f.a = a, f.b = d, f.overlapV.copy(f.overlapN).scale(f.overlap)), g.push(m), g.push(n), !0
        }, a.testEllipseEllipse = function(a, b, c, d, e) {
            var f = g.pop().copy(c.pos).add(d.pos).sub(a.pos).add(b.pos), h = b.radius, i = d.radius, j = h + i, k = j * j, l = f.length2();
            if (l > k)
                return g.push(f), !1;
            if (e) {
                var m = Math.sqrt(l);
            ...
            return g.push(f), !0
        }, a.testPolyShapeEllipse = function(a, b, e, h, i) {
            for (var j = g.pop().copy(e.pos).add(h.pos).sub(a.pos).add(b.pos), k = h.radius, l = k * k, m = b.points, n = m.length, o = g.pop(), p = g.pop(), q = 0, r = 0; n > r; r++) {
                var s = r === n - 1 ? 0 : r + 1, t = 0 === r ? n - 1 : r - 1, u = 0, v = null;
                o.copy(b.edges[r]), p.copy(j).sub(m[r]), i && p.length2() > l && (i.aInB = !1);
                var w = c(o, p);
                if (w === d) {
                    o.copy(b.edges[t]);
                    var x = g.pop().copy(j).sub(m[t]);
                    if (w = c(o, x), w === f) {
                        if (q = p.length(), q > k)
                            return g.push(j), g.push(o), g.push(p), g.push(x), !1;
                        i && (i.bInA = !1, v = p.normalize(), u = k - q)
                    }
                    g.push(x)
                } else if (w === f) {
                    if (o.copy(b.edges[s]), p.copy(j).sub(m[s]), w = c(o, p), w === d) {
                        if (q = p.length(), q > k)
                            return g.push(j), g.push(o), g.push(p), !1;
                        i && (i.bInA = !1, v = p.normalize(), u = k - q)
                    }
                } else {
                    var y = o.perp().normalize();
                    q = p.dotProduct(y);
                    var z = Math.abs(q);
                    if (q > 0 && z > k)
                        return g.push(j), g.push(y), g.push(p), !1;
                    i && (v = y, u = k - q, (q >= 0 || 2 * k > u) && (i.bInA = !1))
                }
                v && i && Math.abs(u) < Math.abs(i.overlap) && (i.overlap = u, i.overlapN.copy(v))
            }
            return i && (i.a = a, i.b = e, i.overlapV.copy(i.overlapN).scale(i.overlap)), g.push(j), g.push(o), g.push(p), !0
        }, a.testEllipsePolyShape = function(b, c, d, e, f) {
            var g = a.testPolyShapeEllipse(d, e, b, c, f);
            if (g && f) {
                var h = f.a, i = f.aInB;
    ...
    me.Renderable = me.Rect.extend({init: function(a, b, c, d) {
            this.isRenderable = !0, this.GUID = void 0, this.inViewport = !1, this.alwaysUpdate = !1, this.updateWhenPaused = !1, this.isPersistent = !1, this.floating = !1, this.z = 0, this.anchorPoint = new me.Vector2d, this.alpha = 1, me.Rect.prototype.init.apply(this, [a, b, c, d]), this.anchorPoint.set(.5, .5), this.setOpacity(1)
        }, getOpacity: function() {
            return this.alpha
            ...
            me.Rect.prototype.draw.apply(this, [a, b])
        }}), me.Renderable.Error = me.Error.extend({init: function(a) {
            me.Error.prototype.init.apply(this, [a]), this.name = "me.Renderable.Error"
        }})
}(), function() {
    me.Sprite = me.Renderable.extend({init: function(a, b, c, d, e) {
            this.scale = new me.Vector2d, this.scaleFlag = !1, this.lastflipX = !1, this.lastflipY = !1, this.z = 0, this.offset = new me.Vector2d, this.angle = 0, this._sourceAngle = 0, this.image = null, this.flickering = !1, this.flickerDuration = 0, this.flickercb = null, this.flickerState = !1, this.isSprite = !0, me.Renderable.prototype.init.apply(this, [a, b, d || c.width, e || c.height]), this.image = c, this.scale.set(1, 1), this.lastflipX = this.lastflipY = !1, this.scaleFlag = !1, this.offset.set(0, 0), this.isPersistent = !1, this.flickering = !1
    ...
    me.AnimationSheet = me.Sprite.extend({init: function(a, b, c) {
            ...
            if ((null === c || "undefined" == typeof c) && (c = this.image), "undefined" != typeof a)
                this.textureAtlas = a, this.atlasIndices = b;
            else {
                if (this.textureAtlas = [], (c.width - this.margin) % (this.width + this.spacing) !== 0 || (c.height - this.margin) % (this.height + this.spacing) !== 0)
                    throw new me.Renderable.Error("Animation sheet for image: " + c.src + " is not divisible by " + (this.width + this.spacing) + "x" + (this.height + this.spacing));
                ...
                for (var g = 0, h = d.x * d.y; h > g; g++)
                    this.textureAtlas[g] = {name: "" + g, offset: new me.Vector2d(this.margin + (this.spacing + this.width) * (g % d.x) + e, this.margin + (this.spacing + this.height) * ~~(g / d.x) + f), width: this.width, height: this.height, hWidth: this.width / 2, hHeight: this.height / 2, angle: 0}
            }
        }, addAnimation: function(a, b, c) {
            if (this.anim[a] = {name: a, frame: [], idx: 0, length: 0, animationspeed: c || this.animationspeed, nextFrame: 0}, null == b) {
                b = [];
                var d = 0;
            ...
            for (var e = 0, f = b.length; f > e; e++)
                if ("number" == typeof b[e])
                    this.anim[a].frame[e] = this.textureAtlas[b[e]];
                else {
            ...
            if (!this.animationpause && (this.current.nextFrame -= a, this.current.nextFrame <= 0)) {
                if (this.setAnimationFrame(++this.current.idx), 0 === this.current.idx && this.resetAnim)
                    ...
                    else if ("function" == typeof this.resetAnim && this.resetAnim() === !1)
                        return this.current.idx = this.current.length - 1, this.setAnimationFrame(this.current.idx), me.Sprite.prototype.update.apply(this, [a]), !1;
    ...
    var a = -(Math.PI / 2);
    me.TextureAtlas = Object.extend({init: function(a, b) {
            if (this.format = null, this.texture = b || null, this.atlas = a || null, a && a.meta) {
                if (a.meta.app.contains("texturepacker"))
                    if (this.format = "texturepacker", "undefined" == typeof b) {
                        ...
                        if (this.texture = me.loader.getImage(c), null === this.texture)
                            throw new me.TextureAtlas.Error("Atlas texture '" + c + "' not found")
                    } else
                        this.texture = b;
                if (a.meta.app.contains("ShoeBox")) {
                    if (!a.meta.exporter || !a.meta.exporter.contains("melonJS"))
            ...
            return a.frames.forEach(function(a) {
                a.hasOwnProperty("filename") && (b[a.filename] = {frame: new me.Rect(a.frame.x, a.frame.y, a.frame.w, a.frame.h), source: new me.Rect(a.spriteSourceSize.x, a.spriteSourceSize.y, a.spriteSourceSize.w, a.spriteSourceSize.h), rotated: a.rotated === !0, trimmed: a.trimmed === !0})
            }), b
        }, getTexture: function() {
            return this.texture
        }, getRegion: function(b) {
            var c = this.atlas[b];
            return c ? {name: b, pos: c.source.pos.clone(), offset: c.frame.pos.clone(), width: c.frame.width, height: c.frame.height, hWidth: c.frame.width / 2, hHeight: c.frame.height / 2, angle: c.rotated === !0 ? a : 0} : null
            ...
            for (var b = [], c = {}, d = 0; d < a.length; ++d)
                if (b[d] = this.getRegion(a[d]), c[a[d]] = d, null == b[d])
                    throw new me.TextureAtlas.Error("TextureAtlas - region for " + a[d] + " not found");
            return new me.AnimationSheet(0, 0, {image: this.texture, spritewidth: 0, spriteheight: 0, margin: 0, spacing: 0, atlas: b, atlasIndices: c})
        }}), me.TextureAtlas.Error = me.Error.extend({init: function(a) {
            me.Error.prototype.init.apply(this, [a]), this.name = "me.TextureAtlas.Error"
        }})
}(), function() {
    var a = Math.min, b = Math.max;
    me.Viewport = me.Renderable.extend({init: function(a, b, c, d) {
            this.AXIS = {NONE: 0, HORIZONTAL: 1, VERTICAL: 2, BOTH: 3}, this.bounds = null, this.deadzone = null, this.target = null, this.follow_axis = 0, this._shake = null, this._fadeIn = null, this._fadeOut = null, this.screenX = 0, this.screenY = 0, me.Renderable.prototype.init.apply(this, [a, b, c - a, d - b]), this.bounds = new me.Rect(-1 / 0, -1 / 0, 1 / 0, 1 / 0), this.offset = new me.Vector2d, this.target = null, this.follow_axis = this.AXIS.NONE, this._shake = {intensity: 0, duration: 0, axis: this.AXIS.BOTH, onComplete: null}, this._fadeOut = {color: null, duration: 0, tween: null}, this._fadeIn = {color: null, duration: 0, tween: null}, this.setDeadzone(this.width / 6, this.height / 6)
        }, _followH: function(c) {
            var d = this.pos.x;
            ...
            if (a instanceof me.Entity)
                this.target = a.pos;
            else {
                if (!(a instanceof me.Vector2d))
            ...
            this._shake.duration > 0 || (this._shake = {intensity: a, duration: b, axis: c || this.AXIS.BOTH, onComplete: d})
        }, fadeOut: function(a, b, c) {
            this._fadeOut.color = me.pool.pull("me.Color").parseHex(a), this._fadeOut.color.alpha = 1, this._fadeOut.duration = b || 1e3, this._fadeOut.tween = me.pool.pull("me.Tween", this._fadeOut.color).to({alpha: 0}, this._fadeOut.duration).onComplete(c || null), this._fadeOut.tween.start()
        }, fadeIn: function(a, b, c) {
            this._fadeIn.color = me.pool.pull("me.Color").parseHex(a), this._fadeIn.color.alpha = 0, this._fadeIn.duration = b || 1e3, this._fadeIn.tween = me.pool.pull("me.Tween", this._fadeIn.color).to({alpha: 1}, this._fadeIn.duration).onComplete(c || null), this._fadeIn.tween.start()
        }, getWidth: function() {
            return this.width
        }, getHeight: function() {
            return this.height
            ...
            this._fadeIn.tween && (me.video.renderer.clearSurface(null, this._fadeIn.color.toRGBA()), 1 === this._fadeIn.color.alpha && (this._fadeIn.tween = null, me.pool.push(this._fadeIn.color), this._fadeIn.color = null)), this._fadeOut.tween && (me.video.renderer.clearSurface(null, this._fadeOut.color.toRGBA()), 0 === this._fadeOut.color.alpha && (this._fadeOut.tween = null, me.pool.push(this._fadeOut.color), this._fadeOut.color = null))
        }})
}(), function() {
    me.GUI_Object = me.Sprite.extend({init: function(a, b, c) {
    ...
    me.Container = me.Renderable.extend({init: function(a, b, c, d) {
            ...
            return"undefined" != typeof a.ancestor ? a.ancestor.removeChildNow(a) : a.isRenderable && (a.GUID = me.utils.createGUID()), "number" == typeof b && (a.z = b), "undefined" == typeof a.z && (a.z = this.children.length), a.ancestor = this, this.children.push(a), this.autoSort === !0 && this.sort(), "function" == typeof a.onActivateEvent && a.onActivateEvent(), a
        }, addChildAt: function(a, b) {
            if (b >= 0 && b < this.children.length)
                return"undefined" != typeof a.ancestor ? a.ancestor.removeChildNow(a) : a.isRenderable && (a.GUID = me.utils.createGUID()), a.ancestor = this, this.children.splice(b, 0, a), "function" == typeof a.onActivateEvent && a.onActivateEvent(), a;
            ...
            for (var a, b, c = this.children.length; c--, b = this.children[c]; )
                b.isRenderable && (a = b.getBounds(), null !== a && this.bounds.union(a));
            return this.bounds
        }, removeChild: function(b, c) {
            b.ancestor && a.defer(this, b, c)
        }, removeChildNow: function(a, b) {
            if (!this.hasChild(a))
                throw new me.Container.Error(a + " The supplied child must be a child of the caller " + this);
            ...
            if (c === !0 || "string" == typeof b)
                throw new me.Container.Error("Advanced collision detection through the `me.game.collide` function is deprecated, please use the new `me.collision.check` function");
            return me.collision.check(a, !1, null, !0, me.collision.response.clear()) ? me.collision.response : null
        }, sort: function(a) {
            ...
            for (var d, e, f, g, h = !1, i = !1, j = me.state.isPaused(), k = me.game.viewport, l = this.children.length; l--, g = this.children[l]; )
                (!j || g.updateWhenPaused) && (g.isRenderable ? (i = c > 0 || g.floating, i && c++, d = !i, d && (e = g.pos.x, f = g.pos.y, b.translateV(g.pos), b.resize(g.width, g.height)), g.inViewport = i || k.isVisible(b), h |= (g.inViewport || g.alwaysUpdate) && g.update(a), d && b.translate(-e, -f), c > 0 && c--) : h |= g.update(a));
            return h
        }, draw: function(a, b) {
            var c = me.game.viewport, d = !1;
            this.drawCount = 0, a.save(), a.transform(this.transform.a, this.transform.b, this.transform.c, this.transform.d, this.transform.e, this.transform.f), a.setGlobalAlpha(a.globalAlpha() * this.getOpacity()), a.translate(this.pos.x, this.pos.y);
            for (var e, f = this.children.length; f--, e = this.children[f]; )
                d = e.floating, (e.inViewport || d) && e.isRenderable && (d === !0 && (a.save(), a.translate(c.screenX - this.pos.x, c.screenY - this.pos.y)), e.draw(a, b), d === !0 && a.restore(), this.drawCount++);
            a.restore()
        }}), me.Container.Error = me.Renderable.Error.extend({init: function(a) {
            me.Renderable.Error.prototype.init.apply(this, [a]), this.name = "me.Container.Error"
        }})
}(), function() {
    me.ObjectSettings = {name: null, image: null, transparent_color: null, spritewidth: null, spriteheight: null, type: 0, collisionMask: 4294967295}, me.Entity = me.Renderable.extend({init: function(a, b, c) {
            if (this.renderable = null, this.bounds = void 0, "number" != typeof c.width || "number" != typeof c.height)
            ...
            if (me.Renderable.prototype.init.apply(this, [a, b, c.width, c.height]), c.image) {
                ...
                this.renderable = new me.AnimationSheet(0, 0, {image: d, spritewidth: ~~(c.spritewidth || c.width), spriteheight: ~~(c.spriteheight || c.height), spacing: ~~c.spacing, margin: ~~c.margin}), c.transparent_color && this.renderable.setTransparency(c.transparent_color)
            }
            if (this.name = c.name ? c.name.toLowerCase() : "", this.alive = !0, this.lastflipX = !1, this.lastflipY = !1, this.body = new me.Body(this), "function" == typeof c.getShape && this.body.addShape(c.getShape()), this.updateBounds(), "undefined" != typeof c.collisionMask && this.body.setCollisionMask(c.collisionMask), "undefined" != typeof c.collisionType) {
            ...
            a !== this.lastflipX && (this.lastflipX = a, this.renderable && this.renderable.flipX && this.renderable.flipX(a), this.body && this.body.flipX(a))
        }, flipY: function(a) {
            a !== this.lastflipY && (this.lastflipY = a, this.renderable && this.renderable.flipY && this.renderable.flipY(a), this.body && this.body.flipY(a))
        }, distanceTo: function(a) {
            var b = this.pos.x + this.hWidth - (a.pos.x + a.hWidth), c = this.pos.y + this.hHeight - (a.pos.y + a.hHeight);
            return Math.sqrt(b * b + c * c)
        }, distanceToPoint: function(a) {
            var b = this.pos.x + this.hWidth - a.x, c = this.pos.y + this.hHeight - a.y;
            return Math.sqrt(b * b + c * c)
        }, angleTo: function(a) {
            var b = a.pos.x + a.hWidth - (this.pos.x + this.hWidth), c = a.pos.y + a.hHeight - (this.pos.y + this.hHeight);
            return Math.atan2(c, b)
        }, angleToPoint: function(a) {
            var b = a.x - (this.pos.x + this.hWidth), c = a.y - (this.pos.y + this.hHeight);
            return Math.atan2(c, b)
        }, update: function(a) {
            return this.renderable ? this.renderable.update(a) : !1
        }, draw: function(a) {
            if (this.renderable) {
                var b = this.getBounds(), c = ~~(b.pos.x + this.anchorPoint.x * (b.width - this.renderable.width)), d = ~~(b.pos.y + this.anchorPoint.y * (b.height - this.renderable.height));
        ...
        }}), me.CollectableEntity = me.Entity.extend({init: function(a, b, c) {
            me.Entity.prototype.init.apply(this, [a, b, c]), this.body.collisionType = me.collision.types.COLLECTABLE_OBJECT
        }}), me.LevelEntity = me.Entity.extend({init: function(a, b, c) {
            me.Entity.prototype.init.apply(this, [a, b, c]), this.nextlevel = c.to, this.fade = c.fade, this.duration = c.duration, this.fading = !1, this.gotolevel = c.to, this.body.onCollision = this.onCollision.bind(this), this.body.collisionType = me.collision.types.ACTION_OBJECT
            ...
            this.goTo()
        }}), me.Entity.Error = me.Renderable.Error.extend({init: function(a) {
            me.Renderable.Error.prototype.init.apply(this, [a]), this.name = "me.Entity.Error"
        }})
}(), function() {
    me.ScreenObject = Object.extend({init: function() {
        }, reset: function() {
        ...
        var a = 0, b = me.agent.prefixed("requestAnimationFrame"), c = me.agent.prefixed("cancelAnimationFrame") || me.agent.prefixed("cancelRequestAnimationFrame");
        b && c || (b = function(b) {
            var c = window.performance.now(), d = Math.max(0, 16 - (c - a)), e = window.setTimeout(function() {
                b(c + d)
            }, d);
            return a = c + d, e
        }, c = function(a) {
    ...
    var a = me.Renderable.extend({init: function(a, b, c) {
            ...
            var b = a.getContext();
            b.fillStyle = "black", b.fillRect(0, this.height / 2 - this.barHeight / 2, this.width, this.barHeight), b.fillStyle = "#55aa00", b.fillRect(2, this.height / 2 - this.barHeight / 2, this.progress, this.barHeight)
        }}), b = me.Renderable.extend({init: function(a, b) {
            me.Renderable.prototype.init.apply(this, [a, b, 100, 85])
        }, draw: function(a) {
            a.save(), a.translate(this.pos.x, this.pos.y);
            var b = a.getContext();
            b.beginPath(), b.moveTo(.7, 48.9), b.bezierCurveTo(10.8, 68.9, 38.4, 75.8, 62.2, 64.5), b.bezierCurveTo(86.1, 53.1, 97.2, 27.7, 87, 7.7), b.lineTo(87, 7.7), b.bezierCurveTo(89.9, 15.4, 73.9, 30.2, 50.5, 41.4), b.bezierCurveTo(27.1, 52.5, 5.2, 55.8, .7, 48.9), b.lineTo(.7, 48.9), b.lineTo(.7, 48.9), b.closePath(), b.fillStyle = "rgb(255, 255, 255)", b.fill(), b.beginPath(), b.moveTo(84, 7), b.bezierCurveTo(87.6, 14.7, 72.5, 30.2, 50.2, 41.6), b.bezierCurveTo(27.9, 53, 6.9, 55.9, 3.2, 48.2), b.bezierCurveTo(-.5, 40.4, 14.6, 24.9, 36.9, 13.5), b.bezierCurveTo(59.2, 2.2, 80.3, -.8, 84, 7), b.lineTo(84, 7), b.closePath(), b.lineWidth = 5.3, b.strokeStyle = "rgb(255, 255, 255)", b.lineJoin = "miter", b.miterLimit = 4, b.stroke(), a.restore()
        }}), c = me.Renderable.extend({init: function(a, b) {
            ...
            var b = a.getContext(), c = this.logo1.measureText(b, "melon").width, d = (this.width - c - this.logo2.measureText(b, "JS").width) / 2, e = this.height / 2 + this.logo2.measureText(b, "melon").height;
            this.logo1.draw(b, "melon", d, e), d += c, this.logo2.draw(b, "JS", d, e)
        }});
    me.DefaultLoadingScreen = me.ScreenObject.extend({onResetEvent: function() {
            ...
            var e = new b((me.video.renderer.getWidth() - 100) / 2, me.video.renderer.getHeight() / 2 - d.barHeight / 2 - 90);
    ...
    me.loader = function() {
        ...
        function c(a, b, c) {
            ...
            if ("tmx" === a.type && me.levelDirector.addTMXLevel(a.name), a.data)
                return d(a.data, a.format), void b();
        ...
        return f.nocache = "", f.onload = void 0, f.onProgress = void 0, f.Error = me.Error.extend({init: function(a) {
            ...
            for (var c = 0; c < b.length; c++)
                k += f.load(b[c], f.onResourceLoaded.bind(f, b[c]), f.onLoadingError.bind(f, b[c]));
            a()
    ...
    me.Font = me.Renderable.extend({init: function(a, b, c, d) {
            this.fontSize = new me.Vector2d, this.fillStyle = c || "#000000", this.strokeStyle = "#000000", this.lineWidth = 1, this.textAlign = d || "left", this.textBaseline = "top", this.lineHeight = 1, this.setFont(a, b, c, d), this.pos = new me.Vector2d(0, 0), me.Renderable.prototype.init.apply(this, [this.pos.x, this.pos.y, 0, this.fontSize.y])
        }, bold: function() {
            ...
            for (var c = ("" + b).split("\n"), d = 0; d < c.length; d++)
                this.width = Math.max(a.measureText(c[d].trimRight()).width, this.width), this.height += this.fontSize.y * this.lineHeight;
            ...
            for (var e = ("" + b).split("\n"), f = 0; f < e.length; f++)
                a.fillText(e[f].trimRight(), ~~c, ~~d), d += this.fontSize.y * this.lineHeight
    ...
    me.BitmapFont = me.Font.extend({init: function(a, b, c, d) {
            ...
            for (var d = 0; d < c.length; d++)
                this.width = Math.max(c[d].trimRight().length * this.sSize.x, this.width), this.height += this.sSize.y * this.lineHeight;
            return{width: this.width, height: this.height}
        }, draw: function(a, b, c, d) {
            var e = ("" + b).split("\n"), f = c, g = this.sSize.y * this.lineHeight, h = a.globalAlpha();
            a.setGlobalAlpha(a.globalAlpha() * this.getOpacity()), this.pos.set(c, d);
    ...
    me.audio = function() {
        function a(a, b) {
            if (h++ > 3) {
                var e = "melonJS: failed loading " + a;
                if (me.sys.stopOnAudioError !== !1)
                    throw new c.Error(e);
                me.audio.disable(), b && b(), console.log(e + ", disabling audio")
            } else
                d[a].load()
        }
        function b(a) {
        ...
        var c = {}, d = {}, e = {}, f = null, g = null, h = 0;
        return c.Error = me.Error.extend({init: function(a) {
                me.Error.prototype.init.apply(this, [a]), this.name = "me.audio.Error"
            }}), c.init = function(a) {
            if (!me.initialized)
                throw new c.Error("me.audio.init() called before engine initialization.");
            ...
            if ("undefined" == typeof this.audioFormats || 0 === this.audioFormats.length)
                throw new c.Error("target audio extension(s) should be set through me.audio.init() before calling the preloader.");
            for (var j = 0; j < this.audioFormats.length; j++)
                i.push(b.src + b.name + "." + this.audioFormats[j] + me.loader.nocache);
            return d[b.name] = new Howl({urls: i, volume: Howler.volume(), onend: function(a) {
                    e[a] && (e[a](), e[a] = null)
                }, onloaderror: function() {
                    d[b.name] = this, a.call(me.audio, b.name, g)
                }, onload: function() {
                    d[b.name] = this, h = 0, f && f()
                }}), 1
        }, c.play = function(a, b, c, f, g) {
            var h = d[a.toLowerCase()];
            return h && "undefined" != typeof h ? (h.loop(b || !1), h.volume("number" == typeof f ? f.clamp(0, 1) : Howler.volume()), "function" == typeof c || "function" == typeof g ? h.play(void 0, function(a) {
                c && (e[a] = c), g && g(a)
            }) : h.play(), h) : void 0
        }, c.stop = function(a, b) {
            ...
            return f = a.toLowerCase(), me.audio.play(f, !0, null, c, navigator.isCocoonJS && !Howler.usingWebAudio ? b : void 0)
            ...
            for (var a in d)
                d.hasOwnProperty(a) && c.unload(a)
        }, c
    }()
}(), function() {
    me.CanvasRenderer = function() {
        var a = {}, b = null, c = null, d = null, e = null, f = null, g = 0, h = 0;
        return a.init = function(a, i, j, k, l, m) {
            return b = a, c = this.getContext2d(b), d = k, d ? (e = me.video.createCanvas(i, j, !1), f = this.getContext2d(e)) : (e = b, f = c), h = l, g = m, this
            ...
            switch (c) {
                ...
                case"brightness":
                    ...
                    for (e = 0, f = i.length; f > e; e += 4)
                        i[e] *= k, i[e + 1] *= k, i[e + 2] *= k;
                    break;
                case"transparent":
                    var l = me.pool.pull("me.Color").parseHex(d), m = me.pool.pull("me.Color");
                    for (e = 0, f = i.length; f > e; e += 4)
                        m.setColor(i[e], i[e + 1], i[e + 2]), m.equals(l) && (i[e + 3] = 0);
            ...
            a.blitSurface = d ? function() {
                c.drawImage(e, 0, 0, e.width, e.height, 0, 0, h, g)
            } : function() {
            }, a.blitSurface()
        ...
        }, a.drawLine = function(a, b, c, d, e, g) {
            f.lineWidth = g, f.strokeStyle = e, f.beginPath(), f.translate(a, b), f.moveTo(0, 0), f.lineTo(c, d), f.stroke(), f.closePath()
        }, a.drawImage = function(a, b, c, d, e, g, h, i, j) {
            f.drawImage(a, b, c, d, e, g, h, i, j)
        }, a.fillArc = function(a, b, c, d, e, g, h, i) {
            null === i && (i = !1), f.save(), f.beginPath(), f.translate(a - c, b - d), f.scale(c, d), f.arc(1, 1, 1, e, g, i), f.restore(), f.fillStyle = h, f.fill()
        }, a.fillRect = function(a, b, c, d, e) {
            f.fillStyle = e, f.fillRect(a, b, c, d)
            ...
            return f.globalAlpha
        }, a.resetTransform = function() {
            f.setTransform(1, 0, 0, 1, 0, 0)
        }, a.resize = function(a, d) {
            b.width = h = e.width * a, b.height = g = e.height * d, me.device.getPixelRatio() > 1 && (b.style.width = b.width / me.device.getPixelRatio() + "px", b.style.height = b.height / me.device.getPixelRatio() + "px"), this.setImageSmoothing(c, me.sys.scalingInterpolation), this.blitSurface()
        }, a.restore = function() {
            f.restore()
        }, a.rotate = function(a) {
            f.rotate(a)
        ...
        }, a.strokeArc = function(a, b, c, d, e, g, h, i, j) {
            null === i && (i = !1), f.save(), f.beginPath(), f.translate(a - c, b - d), f.scale(c, d), f.arc(1, 1, 1, e, g, i), f.restore(), f.strokeStyle = h, f.lineWidth = j, f.stroke()
        }, a.strokePolyShape = function(a, b, c) {
            this.translate(a.pos.x, a.pos.y), f.strokeStyle = b, f.beginPath(), f.moveTo(a.points[0].x, a.points[0].y), a.points.forEach(function(a) {
                f.lineTo(a.x, a.y), f.moveTo(a.x, a.y)
            }), a.closed === !0 && f.lineTo(a.points[0].x, a.points[0].y), f.lineWidth = c, f.stroke()
        }, a.strokeRect = function(a, b, c, d, e, g) {
            f.strokeStyle = e, f.lineWidth = g, f.strokeRect(a, b, c, d)
        }, a.transform = function(a, b, c, d, e, g) {
    ...
    me.video = function() {
        var a = {}, b = null, c = null, d = -1, e = !1, f = !1, g = !0, h = 1 / 0, i = 1 / 0;
        return a.Error = me.Error.extend({init: function(a) {
                me.Error.prototype.init.apply(this, [a]), this.name = "me.video.Error"
            }}), a.init = function(d, h, i, j, k, l, m) {
            if (!me.initialized)
                throw new a.Error("me.video.init() called before engine initialization.");
            e = k || !1, f = "auto" === l || !1, g = "undefined" != typeof m ? m : !0, l = "auto" !== l ? parseFloat(l || 1) : 1, me.sys.scale = new me.Vector2d(l, l), (f || 1 !== l) && (e = !0);
            var n = i * me.sys.scale.x, o = j * me.sys.scale.y;
            ...
            }, !1), me.event.subscribe(me.event.WINDOW_ONRESIZE, me.video.onresize.bind(me.video)), me.event.subscribe(me.event.WINDOW_ONORIENTATION_CHANGE, me.video.onresize.bind(me.video)), b = a.createCanvas(n, o, !0), d && (c = document.getElementById(d)), c || (c = document.body), c.appendChild(b), !b.getContext)
                return!1;
            switch (h) {
                case me.video.WEBGL:
                    this.renderer = me.WebGLRenderer.init(b.width, b.height, b);
                    break;
                default:
                    this.renderer = me.CanvasRenderer.init(b, i, j, e, n, o)
            }
            var p = me.device.getPixelRatio();
            if (p > 1 && (b.style.width = b.width / p + "px", b.style.height = b.height / p + "px"), window.getComputedStyle) {
                var q = window.getComputedStyle(b, null);
                me.video.setMaxSize(parseInt(q.maxWidth, 10), parseInt(q.maxHeight, 10))
            }
            ...
            h = a || 1 / 0, i = b || 1 / 0
        }, a.createCanvas = function(c, d, e) {
            if (0 === c || 0 === d)
                throw new a.Error("width or height was zero, Canvas could not be initialized !");
            var f = document.createElement("canvas");
            return e === !0 && navigator.isCocoonJS && me.device.android2 !== !0 && (f.screencanvas = !0), f.width = c || b.width, f.height = d || b.height, f
        }, a.getWrapper = function() {
            return c
        }, a.onresize = function() {
            var a = 1, b = 1;
            if (me.device.orientation = "undefined" != typeof window.orientation ? window.orientation : window.outerWidth > window.outerHeight ? 90 : 0, f) {
                var c = me.video.renderer.getScreenCanvas().parentNode, e = Math.min(h, c.width || window.innerWidth), j = Math.min(i, c.height || window.innerHeight);
                if (g) {
                    var k = me.video.renderer.getWidth() / me.video.renderer.getHeight(), l = e / j;
                    a = b = k > l ? e / me.video.renderer.getWidth() : j / me.video.renderer.getHeight()
                } else
                    a = e / me.video.renderer.getWidth(), b = j / me.video.renderer.getHeight();
                if (a *= me.device.getPixelRatio(), b *= me.device.getPixelRatio(), 1 !== a || 1 !== b)
                    return d >= 0 && clearTimeout(d), void(d = me.video.updateDisplaySize.defer(this, a, b))
            }
            me.input._offset = me.video.getPos()
        }, a.updateDisplaySize = function(a, b) {
            me.sys.scale.set(a, b), this.renderer.resize(a, b), me.input._offset = me.video.getPos(), d = -1
        }, a.setAlpha = function(a) {
            "function" == typeof this.renderer.setAlpha && this.renderer.setAlpha(a)
        }, a
    }(), me.video.CANVAS = 0, me.video.WEBGL = 1
}(), function() {
    me.WebGLRenderer = function() {
        var a = {}, b = null, c = null, d = null, e = null;
        return a.init = function(a, f, g) {
            return b = g, c = require("kami").WebGLContext, this.context = new c(a, f, b), d = this.context.gl, e = new me.Color, this.globalAlpha = 1, this
        }, a.blitSurface = function() {
        }, a.clearSurface = function(a, b) {
            b.match(/^\#/) ? e.parseHex(b) : b.match(/^rgb/) ? e.parseRGB(b) : e.parseCSS(b), a.clearColor(e.r / 255, e.g / 255, e.b / 255, 1)
        }, a.getScreenCanvas = function() {
            return b
        }, a.getScreenContext = function() {
            return d
            ...
            b = this.context.view;
            var d = b.width * a, e = b.height * c;
            this.context.resize(d, e), me.device.getPixelRatio() > 1 && (b.style.width = b.width / me.device.getPixelRatio() + "px", b.style.height = b.height / me.device.getPixelRatio() + "px")
        }, a
    }()
}(), function() {
    me.input = function() {
    ...
    function b() {
        j || (w.push({x: 0, y: 0}), h.mouse.pos = new me.Vector2d(0, 0), h._offset = me.video.getPos(), window.addEventListener("scroll", throttle(100, !1, function(a) {
        ...
        if (c || (c = m.indexOf(a.type) === u ? i[m[t]] : i[a.type]), c) {
            ...
            for (var d = 0, e = w.length; e > d; d++) {
                ...
                for (var f, g = c.length; g--, f = c[g]; )
                    if (f.floating === !0 ? (a.gameX = a.gameScreenX, a.gameY = a.gameScreenY) : (a.gameX = a.gameWorldX, a.gameY = a.gameWorldY), f.rect.getBounds().containsPoint(a.gameX, a.gameY) && f.cb(a) === !1) {
                        b = !0;
                        break
                    }
            }
    ...
    function d(a) {
        ...
        if (w.length = 0, a.touches)
            ...
            b = h.globalToLocal(a.clientX, a.clientY), b.id = a.pointerId || 1, w.push(b);
    ...
    function e(a) {
        if (a.target === me.video.renderer.getScreenCanvas()) {
            ...
            if ("mousewheel" === k && (b.deltaY = -1 / 40 * a.wheelDelta, a.wheelDeltaX && (b.deltaX = -1 / 40 * a.wheelDeltaX)), c(b))
                return h._preventDefault(a)
        }
        return!0
    }
    function f(a) {
    ...
    h._offset = null, h.mouse = {pos: null, LEFT: 0, MIDDLE: 1, RIGHT: 2, bind: [0, 0, 0]}, h.throttlingInterval = void 0, h.globalToLocal = function(a, b) {
        ...
        if (b(), !h._KeyBinding[c])
            throw new me.Error("no action defined for keycode " + c);
        h.mouse.bind[a] = c
        ...
        var c = i[a];
        if (c)
            for (var d, e = c.length; e--, d = c[e]; )
                d.rect === b && (d.rect = d.cb = d.floating = null, i[a].splice(e, 1))
    ...
    var a = function() {
        ...
        return a.decode = function(a) {
            if (a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""), me.device.nativeBase64)
                return window.atob(a);
            for (var c, d, e, f, g, h, i, j = [], k = 0; k < a.length; )
                f = b.indexOf(a.charAt(k++)), g = b.indexOf(a.charAt(k++)), h = b.indexOf(a.charAt(k++)), i = b.indexOf(a.charAt(k++)), c = f << 2 | g >> 4, d = (15 & g) << 4 | h >> 2, e = (3 & h) << 6 | i, j.push(String.fromCharCode(c)), 64 !== h && j.push(String.fromCharCode(d)), 64 !== i && j.push(String.fromCharCode(e));
            return j = j.join("")
        }, a.encode = function(a) {
            if (a = a.replace(/\r\n/g, "\n"), me.device.nativeBase64)
                return window.btoa(a);
            for (var c, d, e, f, g, h, i, j = [], k = 0; k < a.length; )
                c = a.charCodeAt(k++), d = a.charCodeAt(k++), e = a.charCodeAt(k++), f = c >> 2, g = (3 & c) << 4 | d >> 4, h = (15 & d) << 2 | e >> 6, i = 63 & e, isNaN(d) ? h = i = 64 : isNaN(e) && (i = 64), j.push(b.charAt(f)), j.push(b.charAt(g)), j.push(b.charAt(h)), j.push(b.charAt(i));
            return j = j.join("")
        }, a
    }();
    me.utils = function() {
        ...
        return b.decodeBase64 = function(b) {
            ...
            for (g = "function" == typeof window.Uint32Array?new Uint32Array(h.length / c):[], d = 0, f = h.length / c; f > d; d++)
                for (g[d] = 0, e = c - 1; e >= 0; --e)
                    g[d] += h.charCodeAt(d * c + e) << (e << 3);
            return g
            ...
            for (var c = [], d = 0; d < a.length; d++)
                for (var e = a[d].split(",", b), f = 0; f < e.length; f++)
                    c.push(+e[f]);
            return c
    ...
    me.Color = Object.extend({init: function(a, b, c, d) {
            ...
            var b;
            if ("rgba" === a.substring(0, 4))
                b = 5;
            else {
                if ("rgb" !== a.substring(0, 3))
                    return this.parseHex(a);
                b = 4
            }
    ...
    me.save = function() {
        ...
        var b = {}, c = {_init: function() {
                ...
                Object.keys(d).forEach(function(e) {
                    a(e) || (!function(a) {
                        Object.defineProperty(c, a, {configurable: !0, enumerable: !0, get: function() {
                                return b[a]
                            }, set: function(c) {
        ...
        return c.parse = function(a, b) {
                ...
                for (var f = 0; f < a.childNodes.length; f++) {
                    ...
                    if ("undefined" == typeof c[h])
                        if (3 === g.nodeType) {
                            ...
                            1 === g.nodeType && (c[h] = me.TMXUtils.parse(g, b), c[h]._draworder = b++);
                    else
                        Array.isArray(c[h]) === !1 && (c[h] = [c[h]]), c[h].push(me.TMXUtils.parse(g, b)), c[h][c[h].length - 1]._draworder = b++
                }
            ...
            if ("undefined" != typeof e)
                if ("undefined" != typeof e.property) {
                    ...
                    for (var g in e)
                        e.hasOwnProperty(g) && (c[g] = b(e[g]))
        }, c
    }()
}(me.TMXConstants), function(a) {
    me.TMXObjectGroup = Object.extend({init: function(b, c, d, e) {
            this.name = null, this.width = 0, this.height = 0, this.z = 0, this.objects = [];
            var f = this;
            this.name = b, this.width = c[a.TMX_TAG_WIDTH], this.height = c[a.TMX_TAG_HEIGHT], this.z = e, this.objects = [];
            var g = "undefined" != typeof c[a.TMX_TAG_VISIBLE] ? c[a.TMX_TAG_VISIBLE] : !0;
            this.opacity = g === !0 ? parseFloat(c[a.TMX_TAG_OPACITY] || 1).clamp(0, 1) : 0, me.TMXUtils.applyTMXProperties(this, c);
            var h = c.objects || c.object;
            Array.isArray(h) === !0 ? h.forEach(function(a) {
                f.objects.push(new me.TMXObject(a, d, e))
            }) : f.objects.push(new me.TMXObject(h, d, e))
        }, destroy: function() {
            this.objects = null
        ...
        }}), me.TMXObject = Object.extend({init: function(b, c, d) {
            if (this.points = void 0, this.name = b[a.TMX_TAG_NAME], this.x = parseInt(b[a.TMX_TAG_X], 10), this.y = parseInt(b[a.TMX_TAG_Y], 10), this.z = parseInt(d, 10), this.width = parseInt(b[a.TMX_TAG_WIDTH] || 0, 10), this.height = parseInt(b[a.TMX_TAG_HEIGHT] || 0, 10), this.gid = parseInt(b[a.TMX_TAG_GID], 10) || null, this.type = b[a.TMX_TAG_TYPE], this.isEllipse = !1, this.isPolygon = !1, this.isPolyline = !1, "number" == typeof this.gid)
                this.setImage(this.gid, c);
            else if ("undefined" != typeof b[a.TMX_TAG_ELLIPSE])
                this.isEllipse = !0;
            else {
                var e = b[a.TMX_TAG_POLYGON];
                if ("undefined" != typeof e ? this.isPolygon = !0 : (e = b[a.TMX_TAG_POLYLINE], "undefined" != typeof e && (this.isPolyline = !0)), "undefined" != typeof e)
                    if (this.points = [], "undefined" != typeof e.points) {
                        e = e.points.split(" ");
                        for (var f, g = 0; g < e.length; g++)
                            f = e[g].split(","), this.points.push(new me.Vector2d(+f[0], +f[1]))
                    } else {
                        var h = this;
                        e.forEach(function(a) {
                            h.points.push(new me.Vector2d(parseInt(a.x, 10), parseInt(a.y, 10)))
                        })
                    }
            }
            ...
            return this.isEllipse === !0 ? new me.Ellipse(this.width / 2, this.height / 2, this.width, this.height) : this.isPolygon === !0 || this.isPolyline === !0 ? new me.PolyShape(0, 0, this.points, this.isPolygon) : new me.PolyShape(0, 0, [new me.Vector2d, new me.Vector2d(this.width, 0), new me.Vector2d(this.width, this.height), new me.Vector2d(0, this.height)], !0)
        }, getObjectPropertyByName: function(a) {
            return this[a]
        }})
}(me.TMXConstants), function(a) {
    var b = 2147483648, c = 1073741824, d = 536870912;
    me.Tile = me.Rect.extend({init: function(a, e, f, g, h) {
            ...
            null === this.transform && (this.transform = new me.Matrix2d), this.transform.identity(), this.flippedAD && (this.transform.set(0, 1, 1, 0), this.transform.translate(0, this.height - this.width)), this.flippedX && (this.transform.a *= -1, this.transform.c *= -1, this.transform.translate(this.flippedAD ? this.height : this.width, 0)), this.flippedY && (this.transform.b *= -1, this.transform.d *= -1, this.transform.translate(0, this.flippedAD ? this.width : this.height))
        }}), me.TMXTileset = Object.extend({init: function(b) {
            this.type = {SOLID: "solid", PLATFORM: "platform", L_SLOPE: "lslope", R_SLOPE: "rslope", LADDER: "ladder", TOPLADDER: "topladder", BREAKABLE: "breakable"}, this.TileProperties = [], this.tileXOffset = [], this.tileYOffset = [], this.firstgid = this.lastgid = b[a.TMX_TAG_FIRSTGID];
            var c = b[a.TMX_TAG_SOURCE];
            if (c && "tsx" === me.utils.getFileExtension(c).toLowerCase() && (c = me.utils.getBasename(c), b = me.loader.getTMX(c), !b))
                throw new me.Error(c + " TSX tileset not found");
            this.name = b[a.TMX_TAG_NAME], this.tilewidth = parseInt(b[a.TMX_TAG_TILEWIDTH], 10), this.tileheight = parseInt(b[a.TMX_TAG_TILEHEIGHT], 10), this.spacing = parseInt(b[a.TMX_TAG_SPACING] || 0, 10), this.margin = parseInt(b[a.TMX_TAG_MARGIN] || 0, 10), this.tileoffset = new me.Vector2d(0, 0);
            var d = b[a.TMX_TAG_TILEOFFSET];
            d && (this.tileoffset.x = parseInt(d[a.TMX_TAG_X], 10), this.tileoffset.y = parseInt(d[a.TMX_TAG_Y], 10));
            var e = b.tileproperties;
            if (e)
                for (var f in e)
                    e.hasOwnProperty(f) && this.setTileProperty(parseInt(f, 10) + this.firstgid, e[f]);
            else if (b[a.TMX_TAG_TILE]) {
                e = b[a.TMX_TAG_TILE], Array.isArray(e) || (e = [e]);
                for (var g = 0; g < e.length; g++) {
                    var h = e[g][a.TMX_TAG_ID] + this.firstgid, i = {};
                    me.TMXUtils.applyTMXProperties(i, e[g]), this.setTileProperty(h, i)
                }
            }
            ...
            if (j = me.utils.getBasename(j), this.image = j ? me.loader.getImage(j) : null, this.image) {
                ...
                console.log("melonJS: '" + j + "' file for tileset '" + this.name + "' not found!")
        ...
        }}), me.TMXTilesetGroup = Object.extend({init: function() {
            this.tilesets = []
        }, add: function(a) {
    ...
    me.TMXOrthogonalRenderer = Object.extend({init: function(a, b, c, d) {
        ...
        }}), me.TMXIsometricRenderer = Object.extend({init: function(a, b, c, d) {
    ...
    me.ColorLayer = me.Renderable.extend({init: function(a, b, c) {
            ...
            a.fillRect(b.left - d.x, b.top - d.y, b.width, b.height, this.color), a.setGlobalAlpha(c)
        }}), me.ImageLayer = me.Renderable.extend({init: function(a, b, c, d, e, f) {
            if (this.name = a, this.image = d ? me.loader.getImage(me.utils.getBasename(d)) : null, !this.image)
                throw new me.Error("'" + d + "' file for Image Layer '" + this.name + "' not found!");
            this.imagewidth = this.image.width, this.imageheight = this.image.height;
            var g = me.game.viewport;
            b = b ? Math.min(g.width, b) : g.width, c = c ? Math.min(g.height, c) : g.height, me.Renderable.prototype.init.apply(this, [0, 0, b, c]), this.z = e, this.ratio = new me.Vector2d(1, 1), "undefined" != typeof f && ("number" == typeof f ? this.ratio.set(f, f) : this.ratio.setV(f)), this.lastpos = g.pos.clone(), this.floating = !0, this._repeat = "repeat", this.repeatX = !0, this.repeatY = !0, Object.defineProperty(this, "repeat", {get: function() {
                    return this._repeat
                }, set: function(a) {
            ...
            if (0 === this.ratio.x && 0 === this.ratio.y)
                g = Math.min(b.width, this.imagewidth), h = Math.min(b.height, this.imageheight), a.drawImage(this.image, b.left, b.top, g, h, b.left, b.top, g, h);
            else {
                ...
                for (g = Math.min(this.imagewidth - i, this.width), h = Math.min(this.imageheight - j, this.height); ; ) {
                    do
                        a.drawImage(this.image, i, j, g, h, k, l, g, h), j = 0, l += h, h = Math.min(this.imageheight, this.height - l);
                    while (this.repeatY && l < this.height);
                    if (k += g, !this.repeatX || k >= this.width)
                        break;
        ...
        }}), me.CollisionTiledLayer = me.Renderable.extend({init: function(a, b) {
            me.Renderable.prototype.init.apply(this, [0, 0, a, b]), this.isCollisionMap = !0
        }, checkCollision: function(a, b) {
            var c = b.x < 0 ? a.left + b.x : a.right + b.x, d = b.y < 0 ? a.top + b.y : a.bottom + b.y, e = {x: 0, y: 0, xprop: {}, yprop: {}};
            return(0 >= c || c >= this.width) && (e.x = b.x), (0 >= d || d >= this.height) && (e.y = b.y), e
        }}), me.TMXLayer = me.Renderable.extend({init: function(a, b, c, d, e) {
            me.Renderable.prototype.init.apply(this, [0, 0, 0, 0]), this.tilewidth = a, this.tileheight = b, this.orientation = c, this.tilesets = d, this.tileset = this.tilesets ? this.tilesets.getTilesetByIndex(0) : null, this.z = e
        }, initFromJSON: function(b) {
            this.name = b[a.TMX_TAG_NAME], this.cols = parseInt(b[a.TMX_TAG_WIDTH], 10), this.rows = parseInt(b[a.TMX_TAG_HEIGHT], 10);
            var c = "undefined" != typeof b[a.TMX_TAG_VISIBLE] ? b[a.TMX_TAG_VISIBLE] : !0;
            this.setOpacity(c ? parseFloat(b[a.TMX_TAG_OPACITY]) : 0), "isometric" === this.orientation ? (this.width = (this.cols + this.rows) * (this.tilewidth / 2), this.height = (this.cols + this.rows) * (this.tileheight / 2)) : (this.width = this.cols * this.tilewidth, this.height = this.rows * this.tileheight), me.TMXUtils.applyTMXProperties(this, b), "undefined" == typeof this.preRender && (this.preRender = me.sys.preRender), this.isCollisionMap = this.name.toLowerCase().contains(a.COLLISION_LAYER), this.isCollisionMap === !0 && this.setOpacity(0), this.preRender === !0 && (this.layerCanvas = me.video.createCanvas(this.cols * this.tilewidth, this.rows * this.tileheight), this.layerSurface = me.CanvasRenderer.getContext2d(this.layerCanvas))
        }, destroy: function() {
            ...
            var c = b.x < 0 ? ~~(a.left + b.x) : Math.ceil(a.right - 1 + b.x), d = b.y < 0 ? ~~(a.top + b.y) : Math.ceil(a.bottom - 1 + b.y), e = {x: 0, xtile: void 0, xprop: {}, y: 0, ytile: void 0, yprop: {}};
    ...
    me.TMXTileMap = me.Renderable.extend({init: function(a) {
            ...
            for (var d = this.mapLayers.length; d--; )
                if (this.mapLayers[d].name.toLowerCase().contains(b)) {
                    c = this.mapLayers[d];
                    break
                }
            return b.toLowerCase().contains(a.COLLISION_LAYER) && null == c && (c = new me.CollisionTiledLayer(me.game.currentLevel.width, me.game.currentLevel.height)), c
        }, clearTile: function(a, b) {
            ...
            if (this.initialized === !0) {
                for (a = this.mapLayers.length; a--; )
                    this.mapLayers[a] = null;
    ...
    me.TMXMapReader = Object.extend({init: function() {
            ...
            var e = c[a.TMX_TAG_NAME], f = parseInt(c[a.TMX_TAG_WIDTH], 10), g = parseInt(c[a.TMX_TAG_HEIGHT], 10), h = "string" != typeof c[a.TMX_TAG_IMAGE] ? c[a.TMX_TAG_IMAGE].source : c[a.TMX_TAG_IMAGE], i = new me.ImageLayer(e, f * b.tilewidth, g * b.tileheight, h, d), j = "undefined" != typeof c[a.TMX_TAG_VISIBLE] ? c[a.TMX_TAG_VISIBLE] : !0;
            return i.setOpacity(j === !0 ? parseFloat(c[a.TMX_TAG_OPACITY] || 1).clamp(0, 1) : 0), me.TMXUtils.applyTMXProperties(i, c), "number" == typeof i.ratio && (i.ratio = new me.Vector2d(parseFloat(i.ratio), parseFloat(i.ratio))), i
        }, readTileset: function(a) {
            return new me.TMXTileset(a)
        }, readObjectGroup: function(b, c, d) {
            return new me.TMXObjectGroup(c[a.TMX_TAG_NAME], c, b.tilesets, d)
        }})
}(me.TMXConstants), function() {
    me.levelDirector = function() {
        var a = {}, b = {}, c = [], d = 0, e = function(a, b) {
            b.autoSort = !1, me.game.currentLevel = a, me.game.collisionMap = me.game.currentLevel.getLayerByName("collision"), me.game.collisionMap && me.game.collisionMap.isCollisionMap || console.error("WARNING : no collision map detected"), me.game.viewport.setBounds(0, 0, Math.max(a.width, me.game.viewport.width), Math.max(a.height, me.game.viewport.height)), a.setDefaultPosition(me.game.viewport.width, me.game.viewport.height);
            for (var c = a.getLayers(), d = c.length; d--; )
                b.addChild(c[d]);
            for (var e = b, f = a.getObjectGroups(), g = 0; g < f.length; g++) {
                var h = f[g];
                me.game.mergeGroup === !1 && (e = new me.Container, e.name = h.name, e.z = h.z, e.setOpacity(h.opacity), e.autoSort = !1);
                for (var i = 0; i < h.objects.length; i++) {
                    var j = h.objects[i], k = me.pool.pull(j.name, j.x, j.y, "TileObject" === j.name ? j.image : j);
                    k && (k.z = h.z, me.game.mergeGroup === !0 && k.isRenderable === !0 && (k.setOpacity(k.getOpacity() * h.opacity), k.renderable instanceof me.Renderable && k.renderable.setOpacity(k.renderable.getOpacity() * h.opacity)), e.addChild(k))
                }
        ...
        return a.reset = function() {
            ...
            if (f = f.toString().toLowerCase(), "undefined" == typeof b[f])
                throw new me.Error("level " + f + " not found");
            if (!(b[f]instanceof me.TMXTileMap))
                throw new me.Error("no level loader defined");
 ...
 */
        function() {
            me.Tween = function(a) {
                ...
                for (var s in a)
                    "object" != typeof a && (c[s] = parseFloat(a[s], 10));
                this.onResetEvent = function(a) {
                    ...
                    if (null !== q && q.call(b, u), 1 === t) {
                        ...
                        for (var y = 0, z = n.length; z > y; y++)
                            n[y].start(s);
                        return!1
                    }
                    return!0
                }
            }, me.Tween.Easing = {Linear: {None: function(a) {
                        return a
                    ...
                    }}}, me.Tween.Interpolation = {Linear: function(a, b) {
                    ...
                    }}}, me.Tween.Error = me.Error.extend({init: function(a) {
        ...
        function() {
            ...
            var g = function(a) {
                this._volume = 1, this._muted = !1, this.usingWebAudio = c, this.ctx = b, this.noAudio = d, this._howls = [], this._codecs = a, this.iOSAutoEnable = !0
            };
            g.prototype = {volume: function(a) {
                    var b = this;
                    if (a = parseFloat(a), a >= 0 && 1 >= a) {
                        ...
                        for (var d in b._howls)
                            if (b._howls.hasOwnProperty(d) && b._howls[d]._webAudio === !1)
                                for (var e = 0; e < b._howls[d]._audioNode.length; e++)
                                    b._howls[d]._audioNode[e].volume = b._howls[d]._volume * b._volume;
                        return b
                    }
                    ...
                    for (var d in b._howls)
                        if (b._howls.hasOwnProperty(d) && b._howls[d]._webAudio === !1)
                            for (var e = 0; e < b._howls[d]._audioNode.length; e++)
                                b._howls[d]._audioNode[e].muted = a
                }, codecs: function(a) {
            ...
            var h = null, i = {};
            d || (h = new Audio, i = {mp3: !!h.canPlayType("audio/mpeg;").replace(/^no$/, ""), opus: !!h.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/, ""), ogg: !!h.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, ""), wav: !!h.canPlayType('audio/wav; codecs="1"').replace(/^no$/, ""), aac: !!h.canPlayType("audio/aac;").replace(/^no$/, ""), m4a: !!(h.canPlayType("audio/x-m4a;") || h.canPlayType("audio/m4a;") || h.canPlayType("audio/aac;")).replace(/^no$/, ""), mp4: !!(h.canPlayType("audio/x-mp4;") || h.canPlayType("audio/mp4;") || h.canPlayType("audio/aac;")).replace(/^no$/, ""), weba: !!h.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")});
            var j = new g(i), k = function(a) {
                var d = this;
                d._autoplay = a.autoplay || !1, d._buffer = a.buffer || !1, d._duration = a.duration || 0, d._format = a.format || null, d._loop = a.loop || !1, d._loaded = !1, d._sprite = a.sprite || {}, d._src = a.src || "", d._pos3d = a.pos3d || [0, 0, -.5], d._volume = void 0 !== a.volume ? a.volume : 1, d._urls = a.urls || [], d._rate = a.rate || 1, d._model = a.model || null, d._onload = [a.onload || function() {
                    }], d._onloaderror = [a.onloaderror || function() {
                    }], d._onend = [a.onend || function() {
                    }], d._onpause = [a.onpause || function() {
                    }], d._onplay = [a.onplay || function() {
                    }], d._onendTimer = [], d._webAudio = c && !d._buffer, d._audioNode = [], d._webAudio && d._setupAudioNode(), "undefined" != typeof b && b && j.iOSAutoEnable && j._enableiOSAudio(), j._howls.push(d), d.load()
            };
            if (k.prototype = {load: function() {
                    var a = this, b = null;
                    if (d)
                        return void a.on("loaderror");
                    for (var c = 0; c < a._urls.length; c++) {
                        var e, f;
                        if (a._format)
                            e = a._format;
                        else {
                            if (f = a._urls[c], e = /^data:audio\/([^;,]+);/i.exec(f), e || (e = /\.([^.]+)$/.exec(f.split("?", 1)[0])), !e)
                                return void a.on("loaderror");
                            e = e[1].toLowerCase()
                        }
                        if (i[e]) {
                    ...
                    if (!b)
                        return void a.on("loaderror");
                    if (a._src = b, a._webAudio)
                        l(a, b);
                    else {
                        var h = new Audio;
                        h.addEventListener("error", function() {
                            h.error && 4 === h.error.code && (g.noAudio = !0), a.on("loaderror", {type: h.error ? h.error.code : 0})
                        }, !1), a._audioNode.push(h), h.src = b, h._pos = 0, h.preload = "auto", h.volume = j._muted ? 0 : a._volume * j.volume();
                        var k = function() {
                            a._duration = Math.ceil(10 * h.duration) / 10, 0 === Object.getOwnPropertyNames(a._sprite).length && (a._sprite = {_default: [0, 1e3 * a._duration]}), a._loaded || (a._loaded = !0, a.on("load")), a._autoplay && a.play(), h.removeEventListener("canplaythrough", k, !1)
                        };
                    ...
                    return"function" == typeof a && (c = a), a && "function" != typeof a || (a = "_default"), d._loaded ? d._sprite[a] ? (d._inactiveNode(function(e) {
                        ...
                        if (function() {
                            var b = {id: k, sprite: a, loop: i};
                            h = setTimeout(function() {
                                !d._webAudio && i && d.stop(b.id).play(a, b.id), d._webAudio && !i && (d._nodeById(b.id).paused = !0, d._nodeById(b.id)._pos = 0, d._clearEndTimer(b.id)), d._webAudio || i || d.stop(b.id), d.on("end", k)
                            }, 1e3 * g), d._onendTimer.push({timer: h, id: b.id})
                        }(), d._webAudio) {
                            var l = d._sprite[a][0] / 1e3, m = d._sprite[a][1] / 1e3;
                            e.id = k, e.paused = !1, o(d, [i, l, m], k), d._playStart = b.currentTime, e.gain.value = d._volume, "undefined" == typeof e.bufferSource.start ? e.bufferSource.noteGrainOn(0, f, g) : e.bufferSource.start(0, f, g)
                        } else {
                            if (4 !== e.readyState && (e.readyState || !navigator.isCocoonJS))
                                return d._clearEndTimer(k), function() {
                                    var b = d, f = a, g = c, h = e, i = function() {
                                        b.play(f, g), h.removeEventListener("canplaythrough", i, !1)
                                    };
                                    h.addEventListener("canplaythrough", i, !1)
                                }(), d;
                            e.readyState = 4, e.id = k, e.currentTime = f, e.muted = j._muted || e.muted, e.volume = d._volume * j.volume(), setTimeout(function() {
                                e.play()
                            }, 0)
                        }
                    ...
                    if (c)
                        if (c._pos = 0, b._webAudio) {
                            ...
                            isNaN(c.duration) || (c.pause(), c.currentTime = 0);
                    return b
                }, mute: function(a) {
                    var b = this;
                    if (!b._loaded)
                    ...
                    if (e)
                        return a >= 0 ? (d.pause(c), e._pos = a, d.play(e._sprite, c), d) : d._webAudio ? e._pos + (b.currentTime - d._playStart) : e.currentTime;
                    if (a >= 0)
                        return d;
                    for (var f = 0; f < d._audioNode.length; f++)
                        if (d._audioNode[f].paused && 4 === d._audioNode[f].readyState)
                            return d._webAudio ? d._audioNode[f]._pos : d._audioNode[f].currentTime
                }, pos3d: function(a, b, c, d) {
                    var e = this;
                    if (b = "undefined" != typeof b && b ? b : 0, c = "undefined" != typeof c && c ? c : -.5, !e._loaded)
                    ...
                    var a, b = this, c = 0;
                    for (a = 0; a < b._audioNode.length; a++)
                        b._audioNode[a].paused && c++;
                    for (a = b._audioNode.length - 1; a >= 0 && !(5 >= c); a--)
                        b._audioNode[a].paused && (b._webAudio && b._audioNode[a].disconnect(0), c--, b._audioNode.splice(a, 1))
                    ...
                    if ("function" == typeof b)
                        ...
                        for (var e = 0; e < d.length; e++)
                            b ? d[e].call(c, b) : d[e].call(c);
                    return c
                }, off: function(a, b) {
                    var c = this, d = c["_on" + a], e = b ? b.toString() : null;
                    if (e) {
                    ...
                    for (var b = this, c = b._audioNode, d = 0; d < b._audioNode.length; d++)
                        c[d].paused || (b.stop(c[d].id), b.on("end", c[d].id)), b._webAudio ? c[d].disconnect(0) : c[d].src = "";
                    for (d = 0; d < b._onendTimer.length; d++)
                        clearTimeout(b._onendTimer[d].timer);
                    var e = j._howls.indexOf(b);
                    null !== e && e >= 0 && j._howls.splice(e, 1), delete a[b._src], b = null
                }}, c)
                var l = function(b, c) {
                    if (c in a)
                        return b._duration = a[c].duration, void n(b);
                ...
                a._duration = b ? b.duration : a._duration, 0 === Object.getOwnPropertyNames(a._sprite).length && (a._sprite = {_default: [0, 1e3 * a._duration]}), a._loaded || (a._loaded = !0, a.on("load")), a._autoplay && a.play()
            }, o = function(c, d, e) {
                var f = c._nodeById(e);
            ...
            "function" == typeof define && define.amd && define(function() {
                return{Howler: j, Howl: k}
            }), "undefined" != typeof exports && (exports.Howler = j, exports.Howl = k), "undefined" != typeof window && (window.Howler = j, window.Howl = k)
        }(), !function(a) {
    "object" == typeof exports ? module.exports = a() : "function" == typeof define && define.amd ? define(a) : "undefined" != typeof window ? window.kami = a() : "undefined" != typeof global ? global.kami = a() : "undefined" != typeof self && (self.kami = a())
}(function() {
    var a;
    return function b(a, c, d) {
        ...
        return e
                ...
                var c = a("klasse"), d = a("./glutils/Mesh"), e = a("number-util").colorToFloat, f = new c({initialize: function(a, b) {
                        if ("object" != typeof a)
                            throw"GL context not specified to SpriteBatch";
                        if (this.context = a, this.size = b || 500, this.size > 10922)
                            throw"Can't have more than 10922 sprites per batch: " + this.size;
                        this._blendSrc = this.context.gl.ONE, this._blendDst = this.context.gl.ONE_MINUS_SRC_ALPHA, this._blendingEnabled = !0, this._shader = this._createShader(), this.defaultShader = this._shader, this.ownsShader = !0, this.idx = 0, this.drawing = !1, this.mesh = this._createMesh(this.size), this.color = e(255, 255, 255, 255), this.premultiplied = !0
                    }, blendingEnabled: {set: function(a) {
                            var b = this._blendingEnabled;
                            if (this.drawing && this.flush(), this._blendingEnabled = a, this.drawing && b != a) {
                                var c = this.context.gl;
                                a ? c.enable(c.BLEND) : c.disable(c.BLEND)
                            }
                        }, get: function() {
                            return this._blendingEnabled
                        }}, blendSrc: {set: function(a) {
                            this.drawing && this.flush(), this._blendSrc = a
                        }, get: function() {
                            return this._blendSrc
                        }}, blendDst: {set: function(a) {
                            this.drawing && this.flush(), this._blendDst = a
                        }, get: function() {
                            return this._blendDst
                        }}, setBlendFunction: function(a, b) {
                        this.blendSrc = a, this.blendDst = b
                    }, shader: {set: function(a) {
                            var b = this.drawing;
                            b && this.end(), this._shader = a ? a : this.defaultShader, b && this.begin()
                        }, get: function() {
                            return this._shader
                        }}, setColor: function(a, b, c, d) {
                        var f = "number" == typeof a;
                        f && "number" == typeof b && "number" == typeof c ? d = d || 0 === d ? d : 1 : a = b = c = d = f ? a : 1, this.premultiplied && (a *= d, b *= d, c *= d), this.color = e(~~(255 * a), ~~(255 * b), ~~(255 * c), ~~(255 * d))
                    }, _createMesh: function(a) {
                        var b = 4 * a * this.getVertexSize(), c = 6 * a, e = this.context.gl;
                        this.vertices = new Float32Array(b), this.indices = new Uint16Array(c);
                        for (var f = 0, g = 0; c > f; f += 6, g += 4)
                            this.indices[f + 0] = g + 0, this.indices[f + 1] = g + 1, this.indices[f + 2] = g + 2, this.indices[f + 3] = g + 0, this.indices[f + 4] = g + 2, this.indices[f + 5] = g + 3;
                        var h = new d(this.context, !1, b, c, this._createVertexAttributes());
                        return h.vertices = this.vertices, h.indices = this.indices, h.vertexUsage = e.DYNAMIC_DRAW, h.indexUsage = e.STATIC_DRAW, h.dirty = !0, h
                        ...
                        if (this.drawing = !0, this.shader.bind(), this.mesh.bind(this.shader), this._blendingEnabled) {
                        ...
                        if (this.idx > 0 && this.flush(), this.drawing = !1, this.mesh.unbind(this.shader), this._blendingEnabled) {
                            var a = this.context.gl;
                            a.disable(a.BLEND)
                        }
                    }, _preRender: function() {
                        ...
                        if (0 !== this.idx) {
                            var a = this.context.gl;
                            this._blendingEnabled && this._blendSrc && this._blendDst && a.blendFunc(this._blendSrc, this._blendDst), this._preRender();
                            var b = this.getVertexSize(), c = this.idx / (4 * b);
                            this.mesh.verticesDirty = !0, this.mesh.draw(a.TRIANGLES, 6 * c, 0, this.idx), this.idx = 0
                        }
                    }, draw: function() {
                    }, drawVertices: function() {
                    }, drawRegion: function(a, b, c, d, e) {
                        this.draw(a.texture, b, c, d, e, a.u, a.v, a.u2, a.v2)
                    }, destroy: function() {
                ...
                b.exports = f
            }, {"./glutils/Mesh": 7, klasse: 10, "number-util": 11}], 2: [function(a, b) {
                var c = a("klasse"), d = a("./BaseBatch"), e = a("./glutils/Mesh"), f = a("./glutils/ShaderProgram"), g = new c({Mixins: d, initialize: function(a, b) {
                        d.call(this, a, b), this.projection = new Float32Array(2), this.projection[0] = this.context.width / 2, this.projection[1] = this.context.height / 2, this.texture = null
                    }, resize: function(a, b) {
                        this.setProjection(a / 2, b / 2)
                    }, getVertexSize: function() {
                        return g.VERTEX_SIZE
                    }, _createVertexAttributes: function() {
                        var a = this.context.gl;
                        return[new e.Attrib(f.POSITION_ATTRIBUTE, 2), new e.Attrib(f.COLOR_ATTRIBUTE, 4, null, a.UNSIGNED_BYTE, !0, 1), new e.Attrib(f.TEXCOORD_ATTRIBUTE + "0", 2)]
                    }, setProjection: function(a, b) {
                        var c = this.projection[0], d = this.projection[1];
                        this.projection[0] = a, this.projection[1] = b, !this.drawing || a == c && b == d || (this.flush(), this._updateMatrices())
                    }, _createShader: function() {
                        var a = new f(this.context, g.DEFAULT_VERT_SHADER, g.DEFAULT_FRAG_SHADER);
                        return a.log && console.warn("Shader Log:\n" + a.log), a
                        ...
                        var a = this.context.gl;
                        d.prototype.begin.call(this), this.updateMatrices(), this.shader.setUniformi("u_texture0", 0), a.depthMask(!1)
                    }, end: function() {
                        var a = this.context.gl;
                        d.prototype.end.call(this), a.depthMask(!0)
                    }, flush: function() {
                        this.texture && 0 !== this.idx && (d.prototype.flush.call(this), g.totalRenderCalls++)
                    }, draw: function(a, b, c, d, e, f, g, h, i) {
                        if (!this.drawing)
                            throw"Illegal State: trying to draw a batch before begin()";
                        if (a) {
                            null === this.texture || this.texture.id !== a.id ? (this.flush(), this.texture = a) : this.idx == this.vertices.length && this.flush(), d = 0 === d ? d : d || a.width, e = 0 === e ? e : e || a.height, b = b || 0, c = c || 0;
                            var j = b, k = b + d, l = c, m = c + e;
                            f = f || 0, h = 0 === h ? h : h || 1, g = g || 0, i = 0 === i ? i : i || 1;
                            var n = this.color;
                            this.vertices[this.idx++] = j, this.vertices[this.idx++] = l, this.vertices[this.idx++] = n, this.vertices[this.idx++] = f, this.vertices[this.idx++] = g, this.vertices[this.idx++] = k, this.vertices[this.idx++] = l, this.vertices[this.idx++] = n, this.vertices[this.idx++] = h, this.vertices[this.idx++] = g, this.vertices[this.idx++] = k, this.vertices[this.idx++] = m, this.vertices[this.idx++] = n, this.vertices[this.idx++] = h, this.vertices[this.idx++] = i, this.vertices[this.idx++] = j, this.vertices[this.idx++] = m, this.vertices[this.idx++] = n, this.vertices[this.idx++] = f, this.vertices[this.idx++] = i
                        }
                    }, drawVertices: function(a, b, c) {
                        if (!this.drawing)
                            throw"Illegal State: trying to draw a batch before begin()";
                        a && (this.texture != a ? (this.flush(), this.texture = a) : this.idx == this.vertices.length && this.flush(), c = c || 0, this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++], this.vertices[this.idx++] = b[c++])
                    }});
                g.VERTEX_SIZE = 5, g.totalRenderCalls = 0, g.DEFAULT_FRAG_SHADER = ["precision mediump float;", "varying vec2 vTexCoord0;", "varying vec4 vColor;", "uniform sampler2D u_texture0;", "void main(void) {", " gl_FragColor = texture2D(u_texture0, vTexCoord0) * vColor;", "}"].join("\n"), g.DEFAULT_VERT_SHADER = ["attribute vec2 " + f.POSITION_ATTRIBUTE + ";", "attribute vec4 " + f.COLOR_ATTRIBUTE + ";", "attribute vec2 " + f.TEXCOORD_ATTRIBUTE + "0;", "uniform vec2 u_projection;", "varying vec2 vTexCoord0;", "varying vec4 vColor;", "void main(void) {", " gl_Position = vec4( " + f.POSITION_ATTRIBUTE + ".x / u_projection.x - 1.0, " + f.POSITION_ATTRIBUTE + ".y / -u_projection.y + 1.0 , 0.0, 1.0);", " vTexCoord0 = " + f.TEXCOORD_ATTRIBUTE + "0;", " vColor = " + f.COLOR_ATTRIBUTE + ";", "}"].join("\n"), b.exports = g
            }, {"./BaseBatch": 1, "./glutils/Mesh": 7, "./glutils/ShaderProgram": 8, klasse: 10}], 3: [function(a, b) {
                var c = a("klasse"), d = (a("signals"), a("number-util").nextPowerOfTwo, a("number-util").isPowerOfTwo), e = new c({initialize: function f(a) {
                        if ("object" != typeof a)
                            throw"GL context not specified to Texture";
                        this.context = a, this.id = null, this.target = a.gl.TEXTURE_2D, this.width = 0, this.height = 0, this.wrapS = f.DEFAULT_WRAP, this.wrapT = f.DEFAULT_WRAP, this.minFilter = f.DEFAULT_FILTER, this.magFilter = f.DEFAULT_FILTER, this.managedArgs = Array.prototype.slice.call(arguments, 1), this.context.addManagedObject(this), this.create()
                    }, setup: function(a, b, c, d, f, g) {
                        var h = this.gl;
                        if ("string" == typeof a) {
                            var i = new Image, j = arguments[0], k = "function" == typeof arguments[1] ? arguments[1] : null, l = "function" == typeof arguments[2] ? arguments[2] : null;
                            g = !!arguments[3];
                            var m = this;
                            e.USE_DUMMY_1x1_DATA && (m.uploadData(1, 1), this.width = this.height = 0), i.onload = function() {
                                m.uploadImage(i, void 0, void 0, g), k && k()
                            }, i.onerror = function() {
                                g && h.generateMipmap(h.TEXTURE_2D), l && l()
                            }, i.onabort = function() {
                                g && h.generateMipmap(h.TEXTURE_2D), l && l()
                            }, i.src = j
                        } else
                            this.uploadData(a, b, c, d, f, g)
                    }, create: function() {
                        this.gl = this.context.gl;
                        var a = this.gl;
                        this.id = a.createTexture(), this.width = this.height = 0, this.target = a.TEXTURE_2D, this.bind(), a.pixelStorei(a.UNPACK_PREMULTIPLY_ALPHA_WEBGL, e.UNPACK_PREMULTIPLY_ALPHA), a.pixelStorei(a.UNPACK_ALIGNMENT, e.UNPACK_ALIGNMENT), a.pixelStorei(a.UNPACK_FLIP_Y_WEBGL, e.UNPACK_FLIP_Y);
                        var b = e.UNPACK_COLORSPACE_CONVERSION || a.BROWSER_DEFAULT_WEBGL;
                        a.pixelStorei(a.UNPACK_COLORSPACE_CONVERSION_WEBGL, b), this.setWrap(this.wrapS, this.wrapT, !1), this.setFilter(this.minFilter, this.magFilter, !1), 0 !== this.managedArgs.length && this.setup.apply(this, this.managedArgs)
                    }, destroy: function() {
                    ...
                    }, setWrap: function(a, b, c) {
                        a && b ? (this.wrapS = a, this.wrapT = b) : this.wrapS = this.wrapT = a, this._checkPOT(), c || this.bind();
                        var d = this.gl;
                        d.texParameteri(this.target, d.TEXTURE_WRAP_S, this.wrapS), d.texParameteri(this.target, d.TEXTURE_WRAP_T, this.wrapT)
                    }, setFilter: function(a, b, c) {
                        a && b ? (this.minFilter = a, this.magFilter = b) : this.minFilter = this.magFilter = a, this._checkPOT(), c || this.bind();
                        var d = this.gl;
                        d.texParameteri(this.target, d.TEXTURE_MIN_FILTER, this.minFilter), d.texParameteri(this.target, d.TEXTURE_MAG_FILTER, this.magFilter)
                    }, uploadData: function(a, b, c, d, e, f) {
                        var g = this.gl;
                        c = c || g.RGBA, d = d || g.UNSIGNED_BYTE, e = e || null, this.width = a || 0 == a ? a : this.width, this.height = b || 0 == b ? b : this.height, this._checkPOT(), this.bind(), g.texImage2D(this.target, 0, c, this.width, this.height, 0, c, d, e), f && g.generateMipmap(this.target)
                    }, uploadImage: function(a, b, c, d) {
                        var e = this.gl;
                        b = b || e.RGBA, c = c || e.UNSIGNED_BYTE, this.width = a.width, this.height = a.height, this._checkPOT(), this.bind(), e.texImage2D(this.target, 0, b, b, c, a), d && e.generateMipmap(this.target)
                    }, _checkPOT: function() {
                        if (!e.FORCE_POT) {
                            var a = this.minFilter !== e.Filter.LINEAR && this.minFilter !== e.Filter.NEAREST, b = this.wrapS !== e.Wrap.CLAMP_TO_EDGE || this.wrapT !== e.Wrap.CLAMP_TO_EDGE;
                            if (!(!a && !b || d(this.width) && d(this.height)))
                                throw new Error(a ? "Non-power-of-two textures cannot use mipmapping as filter" : "Non-power-of-two textures must use CLAMP_TO_EDGE as wrap")
                        }
                    }, bind: function(a) {
                        var b = this.gl;
                        (a || 0 === a) && b.activeTexture(b.TEXTURE0 + a), b.bindTexture(this.target, this.id)
                    }, toString: function() {
                        return this.id + ":" + this.width + "x" + this.height
                    }});
                e.Filter = {NEAREST: 9728, NEAREST_MIPMAP_LINEAR: 9986, NEAREST_MIPMAP_NEAREST: 9984, LINEAR: 9729, LINEAR_MIPMAP_LINEAR: 9987, LINEAR_MIPMAP_NEAREST: 9985}, e.Wrap = {CLAMP_TO_EDGE: 33071, MIRRORED_REPEAT: 33648, REPEAT: 10497}, e.Format = {DEPTH_COMPONENT: 6402, ALPHA: 6406, RGBA: 6408, RGB: 6407, LUMINANCE: 6409, LUMINANCE_ALPHA: 6410}, e.DataType = {BYTE: 5120, SHORT: 5122, INT: 5124, FLOAT: 5126, UNSIGNED_BYTE: 5121, UNSIGNED_INT: 5125, UNSIGNED_SHORT: 5123, UNSIGNED_SHORT_4_4_4_4: 32819, UNSIGNED_SHORT_5_5_5_1: 32820, UNSIGNED_SHORT_5_6_5: 33635}, e.DEFAULT_WRAP = e.Wrap.CLAMP_TO_EDGE, e.DEFAULT_FILTER = e.Filter.NEAREST, e.FORCE_POT = !1, e.UNPACK_FLIP_Y = !1, e.UNPACK_ALIGNMENT = 1, e.UNPACK_PREMULTIPLY_ALPHA = !0, e.UNPACK_COLORSPACE_CONVERSION = void 0, e.USE_DUMMY_1x1_DATA = !0, e.getNumComponents = function(a) {
                    switch (a) {
                        case e.Format.DEPTH_COMPONENT:
                        case e.Format.ALPHA:
                        case e.Format.LUMINANCE:
                            return 1;
                        case e.Format.LUMINANCE_ALPHA:
                            return 2;
                        case e.Format.RGB:
                            return 3;
                        case e.Format.RGBA:
            ...
            }, {klasse: 10, "number-util": 11, signals: 12}], 4: [function(a, b) {
                var c = a("klasse"), d = new c({initialize: function(a, b, c, d, e) {
                        this.texture = a, this.setRegion(b, c, d, e)
                    }, setUVs: function(a, b, c, d) {
                        if (this.regionWidth = Math.round(Math.abs(c - a) * this.texture.width), this.regionHeight = Math.round(Math.abs(d - b) * this.texture.height), 1 == this.regionWidth && 1 == this.regionHeight) {
                            var e = .25 / this.texture.width;
                            a += e, c -= e;
                            var f = .25 / this.texture.height;
                            b += f, d -= f
                        }
                        this.u = a, this.v = b, this.u2 = c, this.v2 = d
                    }, setRegion: function(a, b, c, d) {
                        a = a || 0, b = b || 0, c = 0 === c || c ? c : this.texture.width, d = 0 === d || d ? d : this.texture.height;
                        var e = 1 / this.texture.width, f = 1 / this.texture.height;
                        this.setUVs(a * e, b * f, (a + c) * e, (b + d) * f), this.regionWidth = Math.abs(c), this.regionHeight = Math.abs(d)
                    }, setFromRegion: function(a, b, c, d, e) {
                        this.texture = a.texture, this.set(a.getRegionX() + b, a.getRegionY() + c, d, e)
                    }, regionX: {get: function() {
                            return Math.round(this.u * this.texture.width)
                        }}, regionY: {get: function() {
                            return Math.round(this.v * this.texture.height)
                        }}, flip: function(a, b) {
                        var c;
                        a && (c = this.u, this.u = this.u2, this.u2 = c), b && (c = this.v, this.v = this.v2, this.v2 = c)
                    }});
                b.exports = d
            }, {klasse: 10}], 5: [function(a, b) {
                var c = a("klasse"), d = a("signals"), e = new c({initialize: function(a, b, c, e) {
                        this.managedObjects = [], this.gl = null, c && "undefined" != typeof window.WebGLRenderingContext && c instanceof window.WebGLRenderingContext && (c = c.canvas, this.gl = c, this.valid = !0, e = void 0), this.view = c || document.createElement("canvas"), this.width = this.view.width = a || 300, this.height = this.view.height = b || 150, this.contextAttributes = e, this.valid = !1, this.lost = new d, this.restored = new d, this.view.addEventListener("webglcontextlost", function(a) {
                            a.preventDefault(), this._contextLost(a)
                        }.bind(this)), this.view.addEventListener("webglcontextrestored", function(a) {
                            a.preventDefault(), this._contextRestored(a)
                    ...
                    }, addManagedObject: function(a) {
                        this.managedObjects.push(a)
                    }, removeManagedObject: function(a) {
                        var b = this.managedObjects.indexOf(a);
                        return b > -1 ? (this.managedObjects.splice(b, 1), a) : null
                    }, destroy: function() {
                        for (var a = 0; a < this.managedObjects.length; a++) {
                            var b = this.managedObjects[a];
                        ...
                        this._initContext();
                        for (var a = 0; a < this.managedObjects.length; a++)
                            this.managedObjects[a].create();
                        this.resize(this.width, this.height), this.restored.dispatch(this)
                    }});
                b.exports = e
            }, {klasse: 10, signals: 12}], 6: [function(a, b) {
                var c = a("klasse"), d = a("../Texture"), e = new c({initialize: function(a, b, c, e) {
                        if ("object" != typeof a)
                            throw"GL context not specified to FrameBuffer";
                        this.id = null, this.context = a, this.texture = new d(a, b, c, e), this.context.addManagedObject(this), this.create()
                    }, width: {get: function() {
                        ...
                        this.gl = this.context.gl;
                        var a = this.gl, b = this.texture;
                        b.bind(), this.id = a.createFramebuffer(), a.bindFramebuffer(a.FRAMEBUFFER, this.id), a.framebufferTexture2D(a.FRAMEBUFFER, a.COLOR_ATTACHMENT0, b.target, b.id, 0);
                        var c = a.checkFramebufferStatus(a.FRAMEBUFFER);
                        if (c != a.FRAMEBUFFER_COMPLETE) {
                            this.destroy();
                            var d = "Framebuffer not complete";
                            switch (c) {
                                case a.FRAMEBUFFER_UNSUPPORTED:
                                    throw new Error(d + ": unsupported");
                                case a.INCOMPLETE_DIMENSIONS:
                                    throw new Error(d + ": incomplete dimensions");
                                case a.INCOMPLETE_ATTACHMENT:
                                    throw new Error(d + ": incomplete attachment");
                                case a.INCOMPLETE_MISSING_ATTACHMENT:
                                    throw new Error(d + ": missing attachment");
                                default:
                                    throw new Error(d)
                                }
                        }
                        ...
                        this.gl, this.texture && this.texture.destroy(), this.id && this.gl && this.gl.deleteFramebuffer(this.id), this.context && this.context.removeManagedObject(this), this.id = null, this.gl = null, this.texture = null, this.context = null
                    }, begin: function() {
                        var a = this.gl;
                        a.viewport(0, 0, this.texture.width, this.texture.height), a.bindFramebuffer(a.FRAMEBUFFER, this.id)
                    }, end: function() {
                        var a = this.gl;
                        a.viewport(0, 0, this.context.width, this.context.height), a.bindFramebuffer(a.FRAMEBUFFER, null)
                    }});
                b.exports = e
            }, {"../Texture": 3, klasse: 10}], 7: [function(a, b) {
                var c = a("klasse"), d = new c({dirty: {set: function(a) {
                            this.verticesDirty = a, this.indicesDirty = a
                        }}, initialize: function(a, b, c, d, e) {
                        if ("object" != typeof a)
                            throw"GL context not specified to Mesh";
                        if (!c)
                            throw"numVerts not specified, must be > 0";
                        this.context = a, this.gl = a.gl, this.numVerts = null, this.numIndices = null, this.vertices = null, this.indices = null, this.vertexBuffer = null, this.indexBuffer = null, this.verticesDirty = !0, this.indicesDirty = !0, this.indexUsage = null, this.vertexUsage = null, this._vertexAttribs = null, this.vertexStride = null, this.numVerts = c, this.numIndices = d || 0, this.vertexUsage = b ? this.gl.STATIC_DRAW : this.gl.DYNAMIC_DRAW, this.indexUsage = b ? this.gl.STATIC_DRAW : this.gl.DYNAMIC_DRAW, this._vertexAttribs = e || [], this.indicesDirty = !0, this.verticesDirty = !0;
                        for (var f = 0, g = 0; g < this._vertexAttribs.length; g++)
                            f += this._vertexAttribs[g].offsetCount;
                        this.vertexStride = 4 * f, this.vertices = new Float32Array(this.numVerts), this.indices = new Uint16Array(this.numIndices), this.context.addManagedObject(this), this.create()
                    }, create: function() {
                        this.gl = this.context.gl;
                        var a = this.gl;
                        this.vertexBuffer = a.createBuffer(), this.indexBuffer = this.numIndices > 0 ? a.createBuffer() : null, this.dirty = !0
                    }, destroy: function() {
                    ...
                    }, _updateBuffers: function(a, b) {
                        var c = this.gl;
                        if (this.numIndices > 0 && (a || c.bindBuffer(c.ELEMENT_ARRAY_BUFFER, this.indexBuffer), this.indicesDirty && (c.bufferData(c.ELEMENT_ARRAY_BUFFER, this.indices, this.indexUsage), this.indicesDirty = !1)), a || c.bindBuffer(c.ARRAY_BUFFER, this.vertexBuffer), this.verticesDirty) {
                            if (b) {
                                var d = this.vertices.subarray(0, b);
                                c.bufferSubData(c.ARRAY_BUFFER, 0, d)
                            } else
                                c.bufferData(c.ARRAY_BUFFER, this.vertices, this.vertexUsage);
                            this.verticesDirty = !1
                        }
                    }, draw: function(a, b, c, d) {
                        if (0 !== b) {
                            var e = this.gl;
                            c = c || 0, this._updateBuffers(!0, d), this.numIndices > 0 ? e.drawElements(a, b, e.UNSIGNED_SHORT, 2 * c) : e.drawArrays(a, c, b)
                        }
                    }, bind: function(a) {
                        var b = this.gl, c = 0, d = this.vertexStride;
                        this._updateBuffers();
                        for (var e = 0; e < this._vertexAttribs.length; e++) {
                            var f = this._vertexAttribs[e], g = null === f.location ? a.getAttributeLocation(f.name) : f.location;
                            b.enableVertexAttribArray(g), b.vertexAttribPointer(g, f.numComponents, f.type || b.FLOAT, f.normalize, d, c), c += 4 * f.offsetCount
                        }
                    }, unbind: function(a) {
                        for (var b = this.gl, c = 0; c < this._vertexAttribs.length; c++) {
                            var d = this._vertexAttribs[c], e = null === d.location ? a.getAttributeLocation(d.name) : d.location;
                            b.disableVertexAttribArray(e)
                        }
                    }});
                d.Attrib = new c({name: null, numComponents: null, location: null, type: null, initialize: function(a, b, c, d, e, f) {
                        this.name = a, this.numComponents = b, this.location = "number" == typeof c ? c : null, this.type = d, this.normalize = Boolean(e), this.offsetCount = "number" == typeof f ? f : this.numComponents
                    }}), b.exports = d
            }, {klasse: 10}], 8: [function(a, b) {
                var c = a("klasse"), d = new c({initialize: function(a, b, c, d) {
                        if (!b || !c)
                            throw"vertex and fragment shaders must be defined";
                        if ("object" != typeof a)
                            throw"GL context not specified to ShaderProgram";
                        this.context = a, this.vertShader = null, this.fragShader = null, this.program = null, this.log = "", this.uniformCache = null, this.attributeCache = null, this.attributeLocations = d, this.vertSource = b.trim(), this.fragSource = c.trim(), this.context.addManagedObject(this), this.create()
                    }, create: function() {
                        this.gl = this.context.gl, this._compileShaders()
                    }, _compileShaders: function() {
                        var a = this.gl;
                        if (this.log = "", this.vertShader = this._loadShader(a.VERTEX_SHADER, this.vertSource), this.fragShader = this._loadShader(a.FRAGMENT_SHADER, this.fragSource), !this.vertShader || !this.fragShader)
                            throw"Error returned when calling createShader";
                        if (this.program = a.createProgram(), a.attachShader(this.program, this.vertShader), a.attachShader(this.program, this.fragShader), this.attributeLocations)
                            for (var b in this.attributeLocations)
                                this.attributeLocations.hasOwnProperty(b) && a.bindAttribLocation(this.program, Math.floor(this.attributeLocations[b]), b);
                        if (a.linkProgram(this.program), this.log += a.getProgramInfoLog(this.program) || "", !a.getProgramParameter(this.program, a.LINK_STATUS))
                            throw"Error linking the shader program:\n" + this.log;
                        this._fetchUniforms(), this._fetchAttributes()
                    }, _fetchUniforms: function() {
                        var a = this.gl;
                        this.uniformCache = {};
                        var b = a.getProgramParameter(this.program, a.ACTIVE_UNIFORMS);
                        if (b)
                            for (var c = 0; b > c; c++) {
                                var d = a.getActiveUniform(this.program, c);
                                if (null !== d) {
                                    var e = d.name, f = a.getUniformLocation(this.program, e);
                                    this.uniformCache[e] = {size: d.size, type: d.type, location: f}
                                }
                            }
                    }, _fetchAttributes: function() {
                        var a = this.gl;
                        this.attributeCache = {};
                        var b = a.getProgramParameter(this.program, a.ACTIVE_ATTRIBUTES);
                        if (b)
                            for (var c = 0; b > c; c++) {
                                var d = a.getActiveAttrib(this.program, c);
                                if (null !== d) {
                                    var e = d.name, f = a.getAttribLocation(this.program, e);
                                    this.attributeCache[e] = {size: d.size, type: d.type, location: f}
                                }
                            }
                    }, _loadShader: function(a, b) {
                        var c = this.gl, d = c.createShader(a);
                        if (!d)
                            return-1;
                        c.shaderSource(d, b), c.compileShader(d);
                        var e = c.getShaderInfoLog(d) || "";
                        if (e) {
                            var f = a === c.VERTEX_SHADER ? "vertex" : "fragment";
                            e = "Error compiling " + f + " shader:\n" + e
                        }
                        if (this.log += e, !c.getShaderParameter(d, c.COMPILE_STATUS))
                            throw this.log;
                        return d
                    }, bind: function() {
                        this.gl.useProgram(this.program)
                    }, destroy: function() {
                        if (this.context && this.context.removeManagedObject(this), this.gl && this.program) {
                            var a = this.gl;
                            a.detachShader(this.program, this.vertShader), a.detachShader(this.program, this.fragShader), a.deleteShader(this.vertShader), a.deleteShader(this.fragShader), a.deleteProgram(this.program)
                        }
                    ...
                    }, getUniformInfo: function(a) {
                        return this.uniformCache[a] || null
                    }, getAttributeInfo: function(a) {
                        return this.attributeCache[a] || null
                    }, getAttributeLocation: function(a) {
                        var b = this.getAttributeInfo(a);
                        return b ? b.location : null
                    }, getUniformLocation: function(a) {
                        var b = this.getUniformInfo(a);
                        return b ? b.location : null
                    }, hasUniform: function(a) {
                        return null !== this.getUniformInfo(a)
                    }, hasAttribute: function(a) {
                        return null !== this.getAttributeInfo(a)
                    }, getUniform: function(a) {
                        return this.gl.getUniform(this.program, this.getUniformLocation(a))
                    }, getUniformAt: function(a) {
                        return this.gl.getUniform(this.program, a)
                    }, setUniformi: function(a, b, c, d, e) {
                        "use strict";
                        var f = this.gl, g = this.getUniformLocation(a);
                        if (null === g)
                            return!1;
                        switch (arguments.length) {
                            case 2:
                                return f.uniform1i(g, b), !0;
                            case 3:
                                return f.uniform2i(g, b, c), !0;
                            case 4:
                                return f.uniform3i(g, b, c, d), !0;
                            case 5:
                                return f.uniform4i(g, b, c, d, e), !0;
                            default:
                                throw"invalid arguments to setUniformi"
                            }
                    }, setUniformf: function(a, b, c, d, e) {
                        "use strict";
                        var f = this.gl, g = this.getUniformLocation(a);
                        if (null === g)
                            return!1;
                        switch (arguments.length) {
                            case 2:
                                return f.uniform1f(g, b), !0;
                            case 3:
                                return f.uniform2f(g, b, c), !0;
                            case 4:
                                return f.uniform3f(g, b, c, d), !0;
                            case 5:
                                return f.uniform4f(g, b, c, d, e), !0;
                            default:
                                throw"invalid arguments to setUniformf"
                            }
                    }, setUniformfv: function(a, b, c) {
                        "use strict";
                        c = c || b.length;
                        var d = this.gl, e = this.getUniformLocation(a);
                        if (null === e)
                            return!1;
                        switch (c) {
                            case 1:
                                return d.uniform1fv(e, b), !0;
                            case 2:
                                return d.uniform2fv(e, b), !0;
                            case 3:
                                return d.uniform3fv(e, b), !0;
                            case 4:
                                return d.uniform4fv(e, b), !0;
                            default:
                                throw"invalid arguments to setUniformf"
                            }
                    }, setUniformiv: function(a, b, c) {
                        "use strict";
                        c = c || b.length;
                        var d = this.gl, e = this.getUniformLocation(a);
                        if (null === e)
                        ...
                        switch (c) {
                            case 1:
                                return d.uniform1iv(e, b), !0;
                            case 2:
                                return d.uniform2iv(e, b), !0;
                            case 3:
                                return d.uniform3iv(e, b), !0;
                            case 4:
                                return d.uniform4iv(e, b), !0;
                            default:
                                throw"invalid arguments to setUniformf"
                            }
                    }, setUniformMatrix3: function(a, b, c) {
                        "use strict";
                        var d = "object" == typeof b && b.val ? b.val : b;
                        c = !!c;
                        var e = this.gl, f = this.getUniformLocation(a);
                        return null === f ? !1 : void e.uniformMatrix3fv(f, c, d)
                    }, setUniformMatrix4: function(a, b, c) {
                        "use strict";
                        var d = "object" == typeof b && b.val ? b.val : b;
                        c = !!c;
                        var e = this.gl, f = this.getUniformLocation(a);
                        return null === f ? !1 : void e.uniformMatrix4fv(f, c, d)
                    }});
                d.POSITION_ATTRIBUTE = "Position", d.NORMAL_ATTRIBUTE = "Normal", d.COLOR_ATTRIBUTE = "Color", d.TEXCOORD_ATTRIBUTE = "TexCoord", b.exports = d
            }, {klasse: 10}], 9: [function(a, b) {
                b.exports = {BaseBatch: a("./BaseBatch.js"), SpriteBatch: a("./SpriteBatch.js"), Texture: a("./Texture.js"), TextureRegion: a("./TextureRegion.js"), WebGLContext: a("./WebGLContext.js"), FrameBuffer: a("./glutils/FrameBuffer.js"), Mesh: a("./glutils/Mesh.js"), ShaderProgram: a("./glutils/ShaderProgram.js"), Signal: a("signals").Signal, Class: a("klasse"), NumberUtil: a("number-util")}
            }, {"./BaseBatch.js": 1, "./SpriteBatch.js": 2, "./Texture.js": 3, "./TextureRegion.js": 4, "./WebGLContext.js": 5, "./glutils/FrameBuffer.js": 6, "./glutils/Mesh.js": 7, "./glutils/ShaderProgram.js": 8, klasse: 10, "number-util": 11, signals: 12}], 10: [function(a, b) {
                function c(a) {
                    return!!a.get && "function" == typeof a.get || !!a.set && "function" == typeof a.set
                }
                function d(a, b, d) {
                    var e = d ? a[b] : Object.getOwnPropertyDescriptor(a, b);
                    return!d && e.value && "object" == typeof e.value && (e = e.value), e && c(e) ? ("undefined" == typeof e.enumerable && (e.enumerable = !0), "undefined" == typeof e.configurable && (e.configurable = !0), e) : !1
                }
                function e(a, b) {
                    var c = Object.getOwnPropertyDescriptor(a, b);
                    return c ? (c.value && "object" == typeof c.value && (c = c.value), c.configurable === !1 ? !0 : !1) : !1
                }
                function f(a, b, c, f) {
                    for (var g in b)
                        if (b.hasOwnProperty(g)) {
                            ...
                            if (i !== !1) {
                                ...
                                if (e(j.prototype, g)) {
                                    if (h.ignoreFinals)
                                        continue;
                                    throw new Error("cannot override final property '" + g + "', set Class.ignoreFinals = true to skip")
                                }
                                Object.defineProperty(a.prototype, g, i)
                            } else
                                a.prototype[g] = b[g]
                        }
                }
                ...
                function h(a) {
                    ...
                    var b, c;
                    if (a.initialize) {
                        if ("function" != typeof a.initialize)
                            throw new Error("initialize must be a function");
                        b = a.initialize, delete a.initialize
                    } else if (a.Extends) {
                        var d = a.Extends;
                        b = function() {
                    ...
                    a.Extends ? (b.prototype = Object.create(a.Extends.prototype), b.prototype.constructor = b, c = a.Extends, delete a.Extends) : b.prototype.constructor = b;
                    var e = null;
                    return a.Mixins && (e = a.Mixins, delete a.Mixins), g(b, e), f(b, a, !0, c), b
                }
                h.extend = f, h.mixin = g, h.ignoreFinals = !1, b.exports = h
            }, {}], 11: [function(a, b) {
                var c = new Int8Array(4), d = new Int32Array(c.buffer, 0, 1), e = new Float32Array(c.buffer, 0, 1), f = function() {
                };
                f.intBitsToFloat = function(a) {
                    return d[0] = a, e[0]
                }, f.floatToIntBits = function(a) {
                    return e[0] = a, d[0]
                }, f.intToFloatColor = function(a) {
                    return f.intBitsToFloat(4278190079 & a)
                }, f.colorToFloat = function(a, b, c, d) {
                    var e = d << 24 | c << 16 | b << 8 | a;
                    return f.intToFloatColor(e)
                }, f.isPowerOfTwo = function(a) {
                    return 0 == (a & a - 1)
                }, f.nextPowerOfTwo = function(a) {
                    return a--, a |= a >> 1, a |= a >> 2, a |= a >> 4, a |= a >> 8, a |= a >> 16, a + 1
                }, b.exports = f
            }, {}], 12: [function(b, c) {
                !function(b) {
                    ...
                    function f() {
                        ...
                        this.dispatch = function() {
                            f.prototype.dispatch.apply(a, arguments)
                        }
                    }
                    d.prototype = {active: !0, params: null, execute: function(a) {
                            var b, c;
                        ...
                        }}, f.prototype = {VERSION: "1.0.0", memorize: !1, _shouldPropagate: !0, active: !0, _registerListener: function(a, b, c, e) {
                            ...
                            if (-1 !== g) {
                                ...
                                f = new d(this, a, b, c, e), this._addBinding(f);
                            ...
                            return e(a, "add"), this._registerListener(a, !1, b, c)
                        }, addOnce: function(a, b, c) {
                            return e(a, "addOnce"), this._registerListener(a, !0, b, c)
                        }, remove: function(a, b) {
                            e(a, "remove");
                    ...
                    var g = f;
                    g.Signal = f, "function" == typeof a && a.amd ? a(function() {
                        return g
                    }) : "undefined" != typeof c && c.exports ? c.exports = g : b.signals = g
                }(this)
            }, {}]}, {}, [9])(9)
}), function() {
    me.plugin = function() {
        var a = {};
        return a.Base = Object.extend({init: function() {
                this.version = "1.1.0"
            }}), a.patch = function(a, b, c) {
            if ("undefined" != typeof a.prototype && (a = a.prototype), "function" == typeof a[b]) {
                var d = a[b];
                Object.defineProperty(a, b, {configurable: !0, value: function(a, b) {
                        return function() {
                            this._patched = d;
            ...
            var c = [];
            if (arguments.length > 2 && (c = Array.prototype.slice.call(arguments, 1)), c[0] = a, me.plugin[b] = new (a.bind.apply(a, c)), !(me.plugin[b] && me.plugin[b]instanceof me.plugin.Base))
                throw new me.Error("Plugin should extend the me.plugin.Base Class !");
            if (me.sys.checkVersion(me.plugin[b].version) > 0)
                throw new me.Error("Plugin version mismatch, expected: " + me.plugin[b].version + ", got: " + me.version)
        }, a
    }()
}(), me.DraggableEntity = function(a, b, c, d) {
    "use strict";
    return a.extend({init: function(c, e, f) {
    ...
    "use strict";
    return a.extend({init: function(c, d, e) {
    ...
    me.ParticleEmitterSettings = {width: 0, height: 0, image: a, totalParticles: 50, angle: Math.PI / 2, angleVariation: 0, minLife: 1e3, maxLife: 3e3, speed: 2, speedVariation: 1, minRotation: 0, maxRotation: 0, minStartScale: 1, maxStartScale: 1, minEndScale: 0, maxEndScale: 0, gravity: 0, wind: 0, followTrajectory: !1, textureAdditive: !1, onlyInViewport: !0, floating: !1, maxParticles: 10, frequency: 100, duration: 1 / 0, framesToSkip: 0}, me.ParticleEmitter = me.Rect.extend({init: function(a, b, c) {
            this._stream = !1, this._frequencyTimer = 0, this._durationTimer = 0, this._enabled = !1, this.isRenderable = !1, me.Rect.prototype.init.apply(this, [a, b, 1 / 0, 1 / 0]), this.autoSort = !1, this.container = new me.ParticleContainer(this), Object.defineProperty(this, "z", {get: function() {
                    return this.container.z
                }, set: function(a) {
                    this.container.z = a
                }, enumerable: !0, configurable: !0}), Object.defineProperty(this, "floating", {get: function() {
                    return this.container.floating
                }, set: function(a) {
                    this.container.floating = a
                }, enumerable: !0, configurable: !0}), this.reset(c)
        }, destroy: function() {
            this.reset()
            ...
            if (this._enabled && this._stream) {
                if (1 / 0 !== this._durationTimer && (this._durationTimer -= a, this._durationTimer <= 0))
    ...
    me.ParticleContainer = me.Container.extend({init: function(a) {
            me.Container.prototype.init.apply(this), this.autoSort = !1, this._updateCount = 0, this._dt = 0, this._emitter = a
        }, update: function(a) {
            if (++this._updateCount > this._emitter.framesToSkip && (this._updateCount = 0), this._updateCount > 0)
                return this._dt += a, !1;
    ...
    me.Particle = me.Renderable.extend({init: function(a) {
            var b = a.getRandomPoint();
            me.Renderable.prototype.init.apply(this, [b.x, b.y, a.image.width, a.image.height]), this.alwaysUpdate = !0, this.image = a.image;
            var c = a.angle + (a.angleVariation > 0 ? (2 * Math.random() - 1) * a.angleVariation : 0), d = a.speed + (a.speedVariation > 0 ? (2 * Math.random() - 1) * a.speedVariation : 0);
